...
/**
 * Class is factory class to create new instances of the component SecurityTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class SecurityTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public SecurityTestComponentFactory( ) {
    // Create new component.
    component = new SecurityTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new JEAFSecurityTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component SecurityTestComponent.
   *
   * @return Component Created SecurityTestComponent. The method never returns null.
   *
