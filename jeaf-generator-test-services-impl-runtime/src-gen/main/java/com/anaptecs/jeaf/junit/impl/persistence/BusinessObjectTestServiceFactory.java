...
import com.anaptecs.jeaf.junit.core.BusinessObjectTestServiceProxy;

/**
 * Factory class for service BusinessObjectTestService.
 */
final class BusinessObjectTestServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public BusinessObjectTestServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new BusinessObjectTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new BusinessObjectTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}