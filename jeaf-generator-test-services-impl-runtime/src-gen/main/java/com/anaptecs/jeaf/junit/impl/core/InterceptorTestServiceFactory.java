...
import com.anaptecs.jeaf.junit.core.InterceptorTestServiceProxy;

/**
 * Factory class for service InterceptorTestService.
 */
final class InterceptorTestServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public InterceptorTestServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new InterceptorTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new InterceptorTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}