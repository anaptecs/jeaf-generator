...
/**
 * Class is factory class to create new instances of the component SchedulingTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class SchedulingTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public SchedulingTestComponentFactory( ) {
    // Create new component.
    component = new SchedulingTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new SchedulingTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component SchedulingTestComponent.
   * 
   * @return Component Created SchedulingTestComponent. The method never returns null.
   * 
