...
/**
 * Class is factory class to create new instances of the component TxNeverComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TxNeverComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TxNeverComponentComponentFactory( ) {
    // Create new component.
    component = new TxNeverComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TxNeverServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TxNeverComponentComponent.
   *
   * @return Component Created TxNeverComponentComponent. The method never returns null.
   *
