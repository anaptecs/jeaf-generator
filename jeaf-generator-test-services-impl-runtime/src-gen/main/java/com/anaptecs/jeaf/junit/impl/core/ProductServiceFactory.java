...
import com.anaptecs.jeaf.junit.openapi.service1.ProductServiceProxy;

/**
 * Factory class for service ProductService.
 */
final class ProductServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public ProductServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new ProductServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new ProductServiceProxy(this.getComponent().getTransactionBehavior());
  }
}