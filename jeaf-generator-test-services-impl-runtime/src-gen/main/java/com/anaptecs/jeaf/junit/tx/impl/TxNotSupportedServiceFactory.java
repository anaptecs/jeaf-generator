...
import com.anaptecs.jeaf.junit.tx.TxNotSupportedServiceProxy;

/**
 * Factory class for service TxNotSupportedService.
 */
final class TxNotSupportedServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TxNotSupportedServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public Class<? extends Service> getServiceInterfaceClass( ) {
    return TxNotSupportedService.class;
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TxNotSupportedServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TxNotSupportedServiceProxy(this.getComponent().getTransactionBehavior());
  }
}