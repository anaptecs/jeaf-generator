...
/**
 * Class is factory class to create new instances of the component TxNotSupportedComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TxNotSupportedComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TxNotSupportedComponentComponentFactory( ) {
    // Create new component.
    component = new TxNotSupportedComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TxNotSupportedServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TxNotSupportedComponentComponent.
   *
   * @return Component Created TxNotSupportedComponentComponent. The method never returns null.
   *
