...
/**
 * Class is factory class to create new instances of the component InterceptorTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class InterceptorTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public InterceptorTestComponentFactory( ) {
    // Create new component.
    component = new InterceptorTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new InterceptorTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component InterceptorTestComponent.
   *
   * @return Component Created InterceptorTestComponent. The method never returns null.
   *
