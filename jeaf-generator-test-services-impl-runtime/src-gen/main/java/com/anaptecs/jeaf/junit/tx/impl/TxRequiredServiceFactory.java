...
import com.anaptecs.jeaf.junit.tx.TxRequiredServiceProxy;

/**
 * Factory class for service TxRequiredService.
 */
final class TxRequiredServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TxRequiredServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public Class<? extends Service> getServiceInterfaceClass( ) {
    return TxRequiredService.class;
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TxRequiredServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TxRequiredServiceProxy(this.getComponent().getTransactionBehavior());
  }
}