...
/**
 * Class is factory class to create new instances of the component TxRequiredComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TxRequiredComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TxRequiredComponentComponentFactory( ) {
    // Create new component.
    component = new TxRequiredComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TxRequiredServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TxRequiredComponentComponent.
   *
   * @return Component Created TxRequiredComponentComponent. The method never returns null.
   *
