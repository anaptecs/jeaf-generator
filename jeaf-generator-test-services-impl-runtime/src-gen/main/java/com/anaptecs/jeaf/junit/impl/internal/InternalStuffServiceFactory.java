...
import com.anaptecs.jeaf.junit.core.InternalStuffServiceProxy;

/**
 * Factory class for service InternalStuffService.
 */
final class InternalStuffServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public InternalStuffServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new InternalStuffServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new InternalStuffServiceProxy(this.getComponent().getTransactionBehavior());
  }
}