...
/**
 * Class is factory class to create new instances of the component TxSupportedComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TxSupportedComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TxSupportedComponentComponentFactory( ) {
    // Create new component.
    component = new TxSupportedComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TxSupportedServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TxSupportedComponentComponent.
   * 
   * @return Component Created TxSupportedComponentComponent. The method never returns null.
   * 
