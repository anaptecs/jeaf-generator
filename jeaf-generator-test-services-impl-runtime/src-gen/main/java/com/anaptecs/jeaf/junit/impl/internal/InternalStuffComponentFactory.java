...
/**
 * Class is factory class to create new instances of the component InternalStuffComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class InternalStuffComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public InternalStuffComponentFactory( ) {
    // Create new component.
    component = new InternalStuffComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new InternalStuffServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component InternalStuffComponent.
   *
   * @return Component Created InternalStuffComponent. The method never returns null.
   *
