...
import com.anaptecs.jeaf.junit.core.JEAFSecurityTestServiceProxy;

/**
 * Factory class for service JEAFSecurityTestService.
 */
final class JEAFSecurityTestServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public JEAFSecurityTestServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new JEAFSecurityTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new JEAFSecurityTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}