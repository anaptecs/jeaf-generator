...
import com.anaptecs.jeaf.junit.core.MailTestServiceProxy;

/**
 * Factory class for service MailTestService.
 */
final class MailTestServiceFactory extends ServiceFactory {
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new MailTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new MailTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}