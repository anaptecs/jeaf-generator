...
import com.anaptecs.jeaf.junit.tx.TxSupportedServiceProxy;

/**
 * Factory class for service TxSupportedService.
 */
final class TxSupportedServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TxSupportedServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public Class<? extends Service> getServiceInterfaceClass( ) {
    return TxSupportedService.class;
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TxSupportedServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TxSupportedServiceProxy(this.getComponent().getTransactionBehavior());
  }
}