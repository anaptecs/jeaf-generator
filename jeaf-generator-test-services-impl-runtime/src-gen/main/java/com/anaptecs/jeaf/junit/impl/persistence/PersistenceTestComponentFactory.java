...
/**
 * Class is factory class to create new instances of the component PersistenceTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class PersistenceTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public PersistenceTestComponentFactory( ) {
    // Create new component.
    component = new PersistenceTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new BusinessObjectTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component PersistenceTestComponent.
   *
   * @return Component Created PersistenceTestComponent. The method never returns null.
   *
