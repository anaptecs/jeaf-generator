...
import com.anaptecs.jeaf.junit.core.JEAFTestServiceProxy;

/**
 * Factory class for service JEAFTestService.
 */
final class JEAFTestServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public JEAFTestServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new JEAFTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new JEAFTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}