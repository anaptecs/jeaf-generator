...
import com.anaptecs.jeaf.junit.tx.TxRequiresNewServiceProxy;

/**
 * Factory class for service TxRequiresNewService.
 */
final class TxRequiresNewServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TxRequiresNewServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public Class<? extends Service> getServiceInterfaceClass( ) {
    return TxRequiresNewService.class;
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TxRequiresNewServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TxRequiresNewServiceProxy(this.getComponent().getTransactionBehavior());
  }
}