...
/**
 * Class is factory class to create new instances of the component TxRequiresNewComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TxRequiresNewComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TxRequiresNewComponentComponentFactory( ) {
    // Create new component.
    component = new TxRequiresNewComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TxRequiresNewServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TxRequiresNewComponentComponent.
   *
   * @return Component Created TxRequiresNewComponentComponent. The method never returns null.
   *
