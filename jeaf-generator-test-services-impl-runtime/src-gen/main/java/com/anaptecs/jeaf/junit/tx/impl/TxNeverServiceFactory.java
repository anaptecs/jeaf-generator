...
import com.anaptecs.jeaf.junit.tx.TxNeverServiceProxy;

/**
 * Factory class for service TxNeverService.
 */
final class TxNeverServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TxNeverServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TxNeverServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TxNeverServiceProxy(this.getComponent().getTransactionBehavior());
  }
}