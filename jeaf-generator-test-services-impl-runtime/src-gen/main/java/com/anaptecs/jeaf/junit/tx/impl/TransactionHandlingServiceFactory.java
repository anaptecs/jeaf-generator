...
import com.anaptecs.jeaf.junit.tx.TransactionHandlingServiceProxy;

/**
 * Factory class for service TransactionHandlingService.
 */
final class TransactionHandlingServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public TransactionHandlingServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new TransactionHandlingServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new TransactionHandlingServiceProxy(this.getComponent().getTransactionBehavior());
  }
}