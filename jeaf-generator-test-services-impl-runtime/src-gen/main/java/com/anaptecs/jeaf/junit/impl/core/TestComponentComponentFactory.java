...
/**
 * Class is factory class to create new instances of the component TestComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TestComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TestComponentComponentFactory( ) {
    ...
    lServiceFactories.add(new JEAFTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TestComponentComponent.
   *
   * @return Component Created TestComponentComponent. The method never returns null.
   *
