...
/**
 * Class is factory class to create new instances of the component RequiredComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class RequiredComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public RequiredComponentComponentFactory( ) {
    // Create new component.
    component = new RequiredComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new RequiredService_1Factory(component));
    lServiceFactories.add(new RequiredService_2Factory(component));
  ...
  /**
   * Method creates a new instance of component RequiredComponentComponent.
   * 
   * @return Component Created RequiredComponentComponent. The method never returns null.
   * 
