...
/**
 * Class is factory class to create new instances of the component TransactionHandlingComponentComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class TransactionHandlingComponentComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public TransactionHandlingComponentComponentFactory( ) {
    // Create new component.
    component = new TransactionHandlingComponentComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new TransactionHandlingServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component TransactionHandlingComponentComponent.
   *
   * @return Component Created TransactionHandlingComponentComponent. The method never returns null.
   *
