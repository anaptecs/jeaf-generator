...
import com.anaptecs.jeaf.junit.core.JEAFAuthorizationTestServiceProxy;

/**
 * Factory class for service JEAFAuthorizationTestService.
 */
final class JEAFAuthorizationTestServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public JEAFAuthorizationTestServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceImplementation createServiceInstance( ) {
    return new JEAFAuthorizationTestServiceImpl(this.getComponent());
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new JEAFAuthorizationTestServiceProxy(this.getComponent().getTransactionBehavior());
  }
}