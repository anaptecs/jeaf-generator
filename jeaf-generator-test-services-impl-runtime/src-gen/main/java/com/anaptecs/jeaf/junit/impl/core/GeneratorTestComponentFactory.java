...
/**
 * Class is factory class to create new instances of the component GeneratorTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class GeneratorTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public GeneratorTestComponentFactory( ) {
    // Create new component.
    component = new GeneratorTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new GeneratorTestServiceFactory(component));
    lServiceFactories.add(new ValidationTestServiceFactory(component));
