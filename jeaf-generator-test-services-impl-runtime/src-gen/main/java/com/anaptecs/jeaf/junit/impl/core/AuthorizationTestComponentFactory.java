...
/**
 * Class is factory class to create new instances of the component AuthorizationTestComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class AuthorizationTestComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public AuthorizationTestComponentFactory( ) {
    // Create new component.
    component = new AuthorizationTestComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new JEAFAuthorizationTestServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component AuthorizationTestComponent.
   *
   * @return Component Created AuthorizationTestComponent. The method never returns null.
   *
