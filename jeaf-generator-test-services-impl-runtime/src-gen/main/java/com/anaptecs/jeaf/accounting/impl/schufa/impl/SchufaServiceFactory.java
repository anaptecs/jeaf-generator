...
import com.anaptecs.jeaf.accounting.impl.schufa.SchufaServiceProxy;
...
/**
 * Factory class for service SchufaService.
 */
final class SchufaServiceFactory extends ServiceFactory {
  /**
   ...
   */
  public SchufaServiceFactory( ComponentImplementation pComponent ) {
    super(pComponent);
  }
  ...
  public ServiceProxy createServiceProxy( ) {
    ...
    return new SchufaServiceProxy(this.getComponent().getTransactionBehavior());
  }
}