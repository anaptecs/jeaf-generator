...
/**
 * Class is factory class to create new instances of the component SCHUFAComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class SCHUFAComponentFactory implements ComponentFactory {
  /**
  ...
  /**
   * Method creates a new instance of component SCHUFAComponent.
   * 
   * @return Component Created SCHUFAComponent. The method never returns null.
   * 
