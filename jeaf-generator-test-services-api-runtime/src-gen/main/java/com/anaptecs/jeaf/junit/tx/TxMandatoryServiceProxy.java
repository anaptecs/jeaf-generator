...
/**
 * ServiceProxy class for JEAF service TxMandatoryService.
 */
public final class TxMandatoryServiceProxy extends ServiceProxy implements TxMandatoryService {
  /**
   ...
   */
  public TxMandatoryServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TxMandatoryService.class, pTransactionBehavior);
  }
  ...
  public void testTransactionBehavior( ) {
    try {
      Command lCommand = new TestTransactionBehavior_TxMandatoryService_Command();
 ...
 */
final class TestTransactionBehavior_TxMandatoryService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TxMandatoryService.class.getMethod("testTransactionBehavior");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TxMandatoryService.class.getName(), "testTransactionBehavior(null)");
    }
  }
   ...
   * 
   */
  TestTransactionBehavior_TxMandatoryService_Command( ) {
    super(TxMandatoryService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TxMandatoryService lService = (TxMandatoryService) pTargetService;
    // Trace service call.
