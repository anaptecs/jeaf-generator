...
/**
 * ServiceProxy class for JEAF service RequiredService_2.
 */
public final class RequiredService_2Proxy extends ServiceProxy implements RequiredService_2 {
  /**
   ...
   */
  public RequiredService_2Proxy( TransactionBehavior pTransactionBehavior ) {
    super(RequiredService_2.class, pTransactionBehavior);
  }

  /**
   * Generated proxy implementation for method
   * {@link com.anaptecs.jeaf.junit.core.RequiredService_2#testContextHandling_2}
   */
  public void testContextHandling_2( ) {
    try {
      Command lCommand = new TestContextHandling_2_RequiredService_2_Command();
...
/**
 * Generated command class for service method "testContextHandling_2".
 */
final class TestContextHandling_2_RequiredService_2_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = RequiredService_2.class.getMethod("testContextHandling_2");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          RequiredService_2.class.getName(), "testContextHandling_2(null)");
    }
  }

  /**
   * Initialize object. All parameters from method "testContextHandling_2" have to be passed as parameters to this
   * command object.
   *
   *
   */
  TestContextHandling_2_RequiredService_2_Command( ) {
    super(RequiredService_2.class);
