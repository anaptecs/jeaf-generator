...
/**
 * ServiceProxy class for JEAF service MyCustomDefaultService.
 */
public final class MyCustomDefaultServiceProxy extends ServiceProxy implements MyCustomDefaultService {
  /**
   ...
   */
  public MyCustomDefaultServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(MyCustomDefaultService.class, pTransactionBehavior);
  }

  /**
   * Generated proxy implementation for method {@link com.anaptecs.jeaf.junit.core.MyCustomDefaultService#doSomething}
   */
  public String doSomething( String pMessage ) {
    try {
      Command lCommand = new DoSomething_String_MyCustomDefaultService_Command(pMessage);
  ...
  /**
   * Generated proxy implementation for method {@link com.anaptecs.jeaf.junit.core.MyCustomDefaultService#doSomeMore}
   */
  public String doSomeMore( ) {
    try {
      Command lCommand = new DoSomeMore_MyCustomDefaultService_Command();
      return (String) this.executeCommand(lCommand);
    }
    catch (ApplicationException e) {
      throw new JEAFSystemException(e.getErrorCode(), e, e.getMessageParameters());
 ...
 */
final class DoSomething_String_MyCustomDefaultService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = MyCustomDefaultService.class.getMethod("doSomething", String.class);
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          MyCustomDefaultService.class.getName(), "doSomething(String.class)");
    }
  }

  /**
   * Attribute transports the method parameter "pMessage" to the service implementation via the service channel.
   */
   ...
   */
  DoSomething_String_MyCustomDefaultService_Command( String pMessage ) {
    super(MyCustomDefaultService.class);
    message = pMessage;
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    MyCustomDefaultService lService = (MyCustomDefaultService) pTargetService;
    // Trace service call.
    Trace lTrace = XFun.getTrace();
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    Serializable lResult = (Serializable) lService.doSomething(message);
...
/**
 * Generated command class for service method "doSomeMore".
 */
final class DoSomeMore_MyCustomDefaultService_Command extends Command {
  /**
   * Default serial version uid.
   */
  private static final long serialVersionUID = 1L;
  ...
  static {
    try {
      SERVICE_METHOD = MyCustomDefaultService.class.getMethod("doSomeMore");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          MyCustomDefaultService.class.getName(), "doSomeMore(null)");
    }
  }

  /**
   * Initialize object. All parameters from method "doSomeMore" have to be passed as parameters to this command object.
   *
   *
   */
  DoSomeMore_MyCustomDefaultService_Command( ) {
    super(MyCustomDefaultService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    Serializable lResult = (Serializable) lService.doSomeMore();
    // Calculate duration of service call in milliseconds
    String lDuration = Long.toString((System.nanoTime() - lStartTime) / MILLISECONDS);
    // Trace result of service call.
    lTrace.write(MessageConstants.RETURNING_FROM_SERVICE_CALL, this.getCalledServiceMethod(), lDuration);
