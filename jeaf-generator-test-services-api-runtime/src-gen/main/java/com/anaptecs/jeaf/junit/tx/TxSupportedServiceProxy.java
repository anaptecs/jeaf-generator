...
/**
 * ServiceProxy class for JEAF service TxSupportedService.
 */
public final class TxSupportedServiceProxy extends ServiceProxy implements TxSupportedService {
  /**
   ...
   */
  public TxSupportedServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TxSupportedService.class, pTransactionBehavior);
  }

  /**
   * Generated proxy implementation for method
   * {@link com.anaptecs.jeaf.junit.tx.TxSupportedService#testTransactionBehavior}
   */
  public void testTransactionBehavior( ) {
    try {
      Command lCommand = new TestTransactionBehavior_TxSupportedService_Command();
 ...
 */
final class TestTransactionBehavior_TxSupportedService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TxSupportedService.class.getMethod("testTransactionBehavior");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TxSupportedService.class.getName(), "testTransactionBehavior(null)");
    }
  }
   ...
   *
   */
  TestTransactionBehavior_TxSupportedService_Command( ) {
    super(TxSupportedService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TxSupportedService lService = (TxSupportedService) pTargetService;
    // Trace service call.
