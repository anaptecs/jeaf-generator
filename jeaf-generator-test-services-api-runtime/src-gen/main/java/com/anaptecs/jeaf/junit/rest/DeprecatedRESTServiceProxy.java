...
/**
 * ServiceProxy class for JEAF service DeprecatedRESTService.
 */
@Deprecated
public final class DeprecatedRESTServiceProxy extends ServiceProxy implements DeprecatedRESTService {
  /**
   ...
   */
  public DeprecatedRESTServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(DeprecatedRESTService.class, pTransactionBehavior);
  }
  ...
  public void doSomething( ) {
    try {
      Command lCommand = new DoSomething_DeprecatedRESTService_Command();
 ...
 */
final class DoSomething_DeprecatedRESTService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = DeprecatedRESTService.class.getMethod("doSomething");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          DeprecatedRESTService.class.getName(), "doSomething(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    DeprecatedRESTService lService = (DeprecatedRESTService) pTargetService;
    // Trace service call.
