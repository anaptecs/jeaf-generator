...
/**
 * ServiceProxy class for JEAF service DeprecatedTestService.
 */
@Deprecated
public final class DeprecatedTestServiceProxy extends ServiceProxy implements DeprecatedTestService {
  /**
   ...
   */
  public DeprecatedTestServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(DeprecatedTestService.class, pTransactionBehavior);
  }
  ...
  public void doSomething( ) {
    try {
      Command lCommand = new DoSomething_DeprecatedTestService_Command();
 ...
 */
final class DoSomething_DeprecatedTestService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = DeprecatedTestService.class.getMethod("doSomething");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          DeprecatedTestService.class.getName(), "doSomething(null)");
    }
  }
   ...
   * 
   */
  DoSomething_DeprecatedTestService_Command( ) {
    super(DeprecatedTestService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    DeprecatedTestService lService = (DeprecatedTestService) pTargetService;
    // Trace service call.
