...
/**
 * ServiceProxy class for JEAF service TxRequiresNewService.
 */
public final class TxRequiresNewServiceProxy extends ServiceProxy implements TxRequiresNewService {
  /**
   ...
   */
  public TxRequiresNewServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TxRequiresNewService.class, pTransactionBehavior);
  }
  ...
  public void testTransactionBehavior( ) {
    try {
      Command lCommand = new TestTransactionBehavior_TxRequiresNewService_Command();
 ...
 */
final class TestTransactionBehavior_TxRequiresNewService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TxRequiresNewService.class.getMethod("testTransactionBehavior");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TxRequiresNewService.class.getName(), "testTransactionBehavior(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TxRequiresNewService lService = (TxRequiresNewService) pTargetService;
    // Trace service call.
