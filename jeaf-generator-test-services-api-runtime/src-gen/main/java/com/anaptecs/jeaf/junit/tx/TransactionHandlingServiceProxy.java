...
/**
 * ServiceProxy class for JEAF service TransactionHandlingService.
 */
public final class TransactionHandlingServiceProxy extends ServiceProxy implements TransactionHandlingService {
  /**
   ...
   */
  public TransactionHandlingServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TransactionHandlingService.class, pTransactionBehavior);
  }
  ...
  public void testIndirectInvocations( ) {
    try {
      Command lCommand = new TestIndirectInvocations_TransactionHandlingService_Command();
...
/**
 * Generated command class for service method "testIndirectInvocations".
 */
final class TestIndirectInvocations_TransactionHandlingService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TransactionHandlingService.class.getMethod("testIndirectInvocations");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TransactionHandlingService.class.getName(), "testIndirectInvocations(null)");
    }
  }

  /**
   * Initialize object. All parameters from method "testIndirectInvocations" have to be passed as parameters to this
   * command object.
   *
   *
   */
  TestIndirectInvocations_TransactionHandlingService_Command( ) {
    super(TransactionHandlingService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TransactionHandlingService lService = (TransactionHandlingService) pTargetService;
    // Trace service call.
    Trace lTrace = XFun.getTrace();
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.testIndirectInvocations();
