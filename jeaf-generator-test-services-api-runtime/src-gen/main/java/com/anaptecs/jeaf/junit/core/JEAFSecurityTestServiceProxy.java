...
/**
 * ServiceProxy class for JEAF service JEAFSecurityTestService.
 */
public final class JEAFSecurityTestServiceProxy extends ServiceProxy implements JEAFSecurityTestService {
  /**
   ...
   */
  public JEAFSecurityTestServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(JEAFSecurityTestService.class, pTransactionBehavior);
  }
  ...
  public void checkCurrentUser( ) {
    try {
      Command lCommand = new CheckCurrentUser_JEAFSecurityTestService_Command();
  ...
  public void checkInvalidServiceAccess( ) {
    try {
      Command lCommand = new CheckInvalidServiceAccess_JEAFSecurityTestService_Command();
      this.executeCommand(lCommand);
    }
    catch (ApplicationException e) {
      throw new JEAFSystemException(e.getErrorCode(), e, e.getMessageParameters());
  ...
  public void checkCurrentAnonymousUser( ) {
    try {
      Command lCommand = new CheckCurrentAnonymousUser_JEAFSecurityTestService_Command();
      this.executeCommand(lCommand);
    }
    catch (ApplicationException e) {
      throw new JEAFSystemException(e.getErrorCode(), e, e.getMessageParameters());
...
/**
 * Generated command class for service method "checkCurrentUser".
 */
final class CheckCurrentUser_JEAFSecurityTestService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = JEAFSecurityTestService.class.getMethod("checkCurrentUser");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          JEAFSecurityTestService.class.getName(), "checkCurrentUser(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    JEAFSecurityTestService lService = (JEAFSecurityTestService) pTargetService;
    // Trace service call.
    Trace lTrace = XFun.getTrace();
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.checkCurrentUser();
...
/**
 * Generated command class for service method "checkInvalidServiceAccess".
 */
final class CheckInvalidServiceAccess_JEAFSecurityTestService_Command extends Command {
  /**
   * Default serial version uid.
   */
  private static final long serialVersionUID = 1L;
  ...
  static {
    try {
      SERVICE_METHOD = JEAFSecurityTestService.class.getMethod("checkInvalidServiceAccess");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          JEAFSecurityTestService.class.getName(), "checkInvalidServiceAccess(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.checkInvalidServiceAccess();
    // Calculate duration of service call in milliseconds
    String lDuration = Long.toString((System.nanoTime() - lStartTime) / MILLISECONDS);
    // Trace result of service call.
    lTrace.write(MessageConstants.RETURNING_FROM_SERVICE_CALL, this.getCalledServiceMethod(), lDuration);
...
/**
 * Generated command class for service method "checkCurrentAnonymousUser".
 */
final class CheckCurrentAnonymousUser_JEAFSecurityTestService_Command extends Command {
  /**
   * Default serial version uid.
   */
  private static final long serialVersionUID = 1L;
  ...
  static {
    try {
      SERVICE_METHOD = JEAFSecurityTestService.class.getMethod("checkCurrentAnonymousUser");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          JEAFSecurityTestService.class.getName(), "checkCurrentAnonymousUser(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.checkCurrentAnonymousUser();
    // Calculate duration of service call in milliseconds
    String lDuration = Long.toString((System.nanoTime() - lStartTime) / MILLISECONDS);
    // Trace result of service call.
    lTrace.write(MessageConstants.RETURNING_FROM_SERVICE_CALL, this.getCalledServiceMethod(), lDuration);
