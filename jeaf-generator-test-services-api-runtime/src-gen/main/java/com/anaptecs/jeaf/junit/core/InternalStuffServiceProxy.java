...
/**
 * ServiceProxy class for JEAF service InternalStuffService.
 */
public final class InternalStuffServiceProxy extends ServiceProxy implements InternalStuffService {
  /**
   ...
   */
  public InternalStuffServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(InternalStuffService.class, pTransactionBehavior);
  }
  ...
  public void testFlush( ServiceObjectID pObjectID ) {
    try {
      Command lCommand = new TestFlush_ServiceObjectID_InternalStuffService_Command(pObjectID);
 ...
 */
final class TestFlush_ServiceObjectID_InternalStuffService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = InternalStuffService.class.getMethod("testFlush", ServiceObjectID.class);
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          InternalStuffService.class.getName(), "testFlush(ServiceObjectID.class)");
    }
  }

  /**
   * Attribute transports the method parameter "pObjectID" to the service implementation via the service channel.
   */
  ...
  TestFlush_ServiceObjectID_InternalStuffService_Command( ServiceObjectID pObjectID ) {
    super(InternalStuffService.class);
    objectID = pObjectID;
    parameters = new Object[] { objectID };
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    InternalStuffService lService = (InternalStuffService) pTargetService;
    // Trace service call.
    Trace lTrace = XFun.getTrace();
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.testFlush(objectID);
