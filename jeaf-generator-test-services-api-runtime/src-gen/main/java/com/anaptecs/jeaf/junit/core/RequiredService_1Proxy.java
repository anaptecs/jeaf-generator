...
/**
 * ServiceProxy class for JEAF service RequiredService_1.
 */
public final class RequiredService_1Proxy extends ServiceProxy implements RequiredService_1 {
  /**
   ...
   */
  public RequiredService_1Proxy( TransactionBehavior pTransactionBehavior ) {
    super(RequiredService_1.class, pTransactionBehavior);
  }
  ...
  public void testContextHandling_1( TestServiceObject pContextObject ) {
    try {
      Command lCommand = new TestContextHandling_1_TestServiceObject_RequiredService_1_Command(pContextObject);
...
/**
 * Generated command class for service method "testContextHandling_1".
 */
final class TestContextHandling_1_TestServiceObject_RequiredService_1_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = RequiredService_1.class.getMethod("testContextHandling_1", TestServiceObject.class);
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          RequiredService_1.class.getName(), "testContextHandling_1(TestServiceObject.class)");
    }
  }

  /**
   * Attribute transports the method parameter "pContextObject" to the service implementation via the service channel.
   */
  private final TestServiceObject contextObject;

  /**
   * Initialize object. All parameters from method "testContextHandling_1" have to be passed as parameters to this
   * command object.
   *
   * @param pContextObject TestServiceObject
   */
  TestContextHandling_1_TestServiceObject_RequiredService_1_Command( TestServiceObject pContextObject ) {
    super(RequiredService_1.class);
    contextObject = pContextObject;
    parameters = new Object[] { contextObject };
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    RequiredService_1 lService = (RequiredService_1) pTargetService;
    // Trace service call.
    Trace lTrace = XFun.getTrace();
    lTrace.write(MessageConstants.EXECUTING_SERVICE_CALL, this.getCalledServiceMethod());
    long lStartTime = System.nanoTime();
    lService.testContextHandling_1(contextObject);
