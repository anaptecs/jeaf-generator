...
/**
 * ServiceProxy class for JEAF service TxRequiredService.
 */
public final class TxRequiredServiceProxy extends ServiceProxy implements TxRequiredService {
  /**
   ...
   */
  public TxRequiredServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TxRequiredService.class, pTransactionBehavior);
  }

  /**
   * Generated proxy implementation for method
   * {@link com.anaptecs.jeaf.junit.tx.TxRequiredService#testTransactionBehavior}
   */
  public void testTransactionBehavior( ) {
    try {
      Command lCommand = new TestTransactionBehavior_TxRequiredService_Command();
 ...
 */
final class TestTransactionBehavior_TxRequiredService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TxRequiredService.class.getMethod("testTransactionBehavior");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TxRequiredService.class.getName(), "testTransactionBehavior(null)");
    }
  }
   ...
   *
   */
  TestTransactionBehavior_TxRequiredService_Command( ) {
    super(TxRequiredService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TxRequiredService lService = (TxRequiredService) pTargetService;
    // Trace service call.
