...
/**
 * ServiceProxy class for JEAF service TxNotSupportedService.
 */
public final class TxNotSupportedServiceProxy extends ServiceProxy implements TxNotSupportedService {
  /**
   ...
   */
  public TxNotSupportedServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(TxNotSupportedService.class, pTransactionBehavior);
  }
  ...
  public void testTransactionBehavior( ) {
    try {
      Command lCommand = new TestTransactionBehavior_TxNotSupportedService_Command();
 ...
 */
final class TestTransactionBehavior_TxNotSupportedService_Command extends Command {
  /**
  ...
  static {
    try {
      SERVICE_METHOD = TxNotSupportedService.class.getMethod("testTransactionBehavior");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          TxNotSupportedService.class.getName(), "testTransactionBehavior(null)");
    }
  }
   ...
   *
   */
  TestTransactionBehavior_TxNotSupportedService_Command( ) {
    super(TxNotSupportedService.class);
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    TxNotSupportedService lService = (TxNotSupportedService) pTargetService;
    // Trace service call.
