...
public class PrimitiveArraysObjectWithRestrictions {
  ...
  public static abstract class PrimitiveArraysObjectWithRestrictionsBuilder<T extends PrimitiveArraysObjectWithRestrictions, S extends PrimitiveArraysObjectWithRestrictionsBuilder<T, S>> {
    private boolean[] aBooleanArray;
