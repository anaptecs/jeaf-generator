 ...
 */
public class LongCodeDeserializer extends JsonDeserializer<LongCode> {
  @Override
  public LongCode deserialize( JsonParser pParser, DeserializationContext pContext ) throws IOException {
    ...
    // Node is not a TextNode
      ...
      throw new IOException(
          "Unable to deserialize object of type LongCode. Expected text node but received other type of JSON content. Current JSON node ''"
