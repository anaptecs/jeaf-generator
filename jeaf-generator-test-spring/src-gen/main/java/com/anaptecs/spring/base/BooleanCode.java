...
public class BooleanCode {
  ...
  public static abstract class BooleanCodeBuilder<T extends BooleanCode, S extends BooleanCodeBuilder<T, S>> {
    private Boolean code;
     ...
     */
    public S setCode( @MyNotNullProperty Boolean pCode ) {
