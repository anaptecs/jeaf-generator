...
public class TechParent {
  ...
  public static abstract class TechParentBuilder<T extends TechParent, S extends TechParentBuilder<T, S>> {
    private String techAttribute;
     ...
     */
    public S setTechAttribute( @MyNotNullProperty String pTechAttribute ) {
