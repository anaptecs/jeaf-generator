 ...
 */
public class BookingCodeDeserializer extends JsonDeserializer<BookingCode> {
  @Override
  public BookingCode deserialize( JsonParser pParser, DeserializationContext pContext ) throws IOException {
    ...
    // Node is not of expected type.
      ...
      throw new IOException(
          "Unable to deserialize object of type BookingCode. Expected node type that matches to data type but received other JSON content. Current JSON node ''"
