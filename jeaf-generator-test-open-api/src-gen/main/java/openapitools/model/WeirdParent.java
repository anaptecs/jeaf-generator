...
public class WeirdParent {
  ...
  public WeirdParent objectType(@javax.annotation.Nonnull String objectType) {
  ...
  public WeirdParent someProperty(@javax.annotation.Nonnull String someProperty) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_SOME_PROPERTY, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SOME_PROPERTY, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSomeProperty(@javax.annotation.Nonnull String someProperty) {
    this.someProperty = someProperty;
  }


  public WeirdParent complexBooking(@javax.annotation.Nonnull String complexBooking) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_COMPLEX_BOOKING, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_COMPLEX_BOOKING, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setComplexBooking(@javax.annotation.Nonnull String complexBooking) {
    this.complexBooking = complexBooking;
  }
