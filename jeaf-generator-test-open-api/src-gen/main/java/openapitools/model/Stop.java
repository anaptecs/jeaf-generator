...
public class Stop {
  ...
  public Stop objectType(@javax.annotation.Nonnull String objectType) {
  ...
  public Stop name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Stop links(@javax.annotation.Nullable List<LinkObject> links) {
    this.links = links;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LINKS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLinks(@javax.annotation.Nullable List<LinkObject> links) {
    this.links = links;
  }


  public Stop index(@javax.annotation.Nonnull Integer index) {
    this.index = index;
    return this;
  }
  ...
  public Stop theSoftLinkID(@javax.annotation.Nonnull String theSoftLinkID) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_THE_SOFT_LINK_I_D, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_THE_SOFT_LINK_I_D, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTheSoftLinkID(@javax.annotation.Nonnull String theSoftLinkID) {
    this.theSoftLinkID = theSoftLinkID;
  }
