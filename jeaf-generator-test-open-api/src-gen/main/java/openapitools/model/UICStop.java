...
public class UICStop extends Stop {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_UIC_CODE, required = true)
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_INDEX2, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @Deprecated
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_INLINE_STOP_TYPE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
