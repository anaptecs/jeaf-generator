...
/**
 *  &lt;br&gt;&lt;br&gt; **Deprecation Notice (since: 0.5, removed with: 2.0, go live date: , end of compatibility period: ):**&lt;br&gt;&lt;br&gt; Please do not use this class any longer. There are better alternatives but I do not tell you which ones. May be &#x60;java.lang.Nothing&#x60; 
 * @deprecated
 */
@Deprecated
@JsonPropertyOrder({
...
public class ChildAA extends ChildA {
  ...
  public ChildAA addCodesItem(Integer codesItem) {
    if (this.codes == null || !this.codes.isPresent() || this.codes.get() == null) {
