...
public class ChildA extends ParentClass {
  ...
  public ChildA childAAttribute(@javax.annotation.Nonnull Integer childAAttribute) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_CHILD_A_ATTRIBUTE, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_CHILD_A_ATTRIBUTE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChildAAttribute(@javax.annotation.Nonnull Integer childAAttribute) {
    this.childAAttribute = childAAttribute;
  }
