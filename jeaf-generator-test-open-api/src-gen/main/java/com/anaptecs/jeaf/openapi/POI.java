...
public class POI extends Stop {
  ...
  **/
   ...
   * @return stops
  **/
  @Schema(required = true, description = " <br><br> **Breaking Change Notice (active with 2024-12-24, go live date: ):**<br><br> New mandatory association is required to support upcoming features. ")
