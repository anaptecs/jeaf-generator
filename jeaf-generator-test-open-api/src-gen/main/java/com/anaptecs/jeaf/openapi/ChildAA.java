 ...
 */
@Schema(description = " <br><br> **Deprecation Notice (since: 0.5, removed with: 2.0, go live date: , end of compatibility period: ):**<br><br> Please do not use this class any longer. There are better alternatives but I do not tell you which ones. May be `java.lang.Nothing` ")
