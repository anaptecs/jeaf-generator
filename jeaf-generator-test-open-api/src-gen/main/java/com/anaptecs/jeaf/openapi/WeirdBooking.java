...
public class WeirdBooking extends WeirdParent {
  ...
  **/
   ...
   * @return inventories
  **/
  @Schema(description = " <br><br> **Breaking Change Notice (active with 2.1, go live date: , end of compatibility phase: ):**<br><br> Association will required at least 1 object. ")
