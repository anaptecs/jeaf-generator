...
public class Reseller {
  ...
  **/
  ...
  public Reseller name(String name) {
   ...
   /**
   *  &lt;br&gt;&lt;br&gt; **Breaking Change Notice (active with 1.1, go live date: , end of compatibility phase: ):**&lt;br&gt;&lt;br&gt; Maximum size will be increased. 
   * @return name
  **/
  @Schema(required = true, description = " <br><br> **Breaking Change Notice (active with 1.1, go live date: , end of compatibility phase: ):**<br><br> Maximum size will be increased. ")
