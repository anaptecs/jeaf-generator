...
public class Campaign {
  ...
  public Campaign theLinkID(Long theLinkID) {
   ...
   /**
   * The magic link. &lt;br&gt;&lt;br&gt; **Deprecation Notice (since: 2.3.1, removed with: 2.4, go live date: , end of compatibility phase: ):**&lt;br&gt;&lt;br&gt; Please use \&quot;moreLinks\&quot; instead. 
   * @return theLinkID
  **/
  @Schema(description = "The magic link. <br><br> **Deprecation Notice (since: 2.3.1, removed with: 2.4, go live date: , end of compatibility phase: ):**<br><br> Please use \"moreLinks\" instead. ")
  ...
  public Campaign addMoreLinkIDsItem(Long moreLinkIDsItem) {
   ...
   /**
   *  &lt;br&gt;&lt;br&gt; **Deprecation Notice (since: 1.2, removed with: 3.0, go live date: , end of compatibility phase: ):**&lt;br&gt;&lt;br&gt; No good any more 
   * @return moreLinkIDs
  **/
  @Schema(required = true, description = " <br><br> **Deprecation Notice (since: 1.2, removed with: 3.0, go live date: , end of compatibility phase: ):**<br><br> No good any more ")
