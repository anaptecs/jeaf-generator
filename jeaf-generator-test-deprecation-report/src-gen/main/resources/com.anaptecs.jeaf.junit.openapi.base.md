...
| `MOBILE` |   |  |
| `TVM` |   |  |
| `WEB` |   | :bomb: **Breaking Change Notice (since: , active with: 1.47.11, go live date: ):**<br>Added new literal |
| :exclamation:`LEGACY_POS` |   | :exclamation:**Deprecation Notice (since: , removed with: , go live date: ):**<br>I'm `DEPRECATED`. |

## ComplexBookingType
:bomb: **Breaking Change Notice (since: , active with: PI 17, go live date: ):**<br>Class was changed to an extensible enum. New literals will not be introduced before PI 17.
...
| `SBB` |   |  |
| `SNCF` |   |  |
| `DB` |   | :bomb: **Breaking Change Notice (since: , active with: 3.x, go live date: ):**<br>New literal will occur |
