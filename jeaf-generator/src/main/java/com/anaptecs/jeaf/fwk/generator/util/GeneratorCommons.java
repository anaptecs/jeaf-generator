...
public class GeneratorCommons {
	/**
	 * Constant defines the pattern that is used to convert time stamps in
	 * string format to java objects. The string representation of a time stamp
	 * has to have the following structure: "yyyy-MM-dd HH:mm:ss.SSS" (e.g.
	 * "2004-11-28 13:31:17.098")
	 */
	public static final String TIMESTAMP_PATTERN = "yyyy-MM-dd HH:mm:ss.SSS";

	/**
	 * Constant defines the name of the system property which contains the
	 * package white list of the generator.
	 */
	...
	public static final String USE_DEPRECATED_SECURED_PROPERTY = "switch.gen.rest.security.useDeprecatedSpringSecuredAnnotation";
	...
	/**
	 * Constant defines the name of the property that defines the REST path
	 * prefix that should be used when generating REST resources.
	 */
	public static final String REST_PATH_PREFIX_PROPERTY = "switch.gen.rest.path.prefix";

	/**
	 * Constant defines the name of the system property which enables the
	 * generation of REST service proxies from the model.
	 */
	...
	/**
	 * Constant defines the name of the system property which enables the
	 * generation of service objects from the model.
	 */
	...
	/**
	 * Constant defines the name of the syste property which enable generation
	 * of public object view of POJO's and ServiceObjects.
	 */
	public static final String GENERATE_PUBLIC_OBJECT_VIEW = "switch.gen.public.object.view";

	/**
	 * Constant defines the name of the system property which disables
	...
	/**
	 * Constant defines the name of the system property that enables generation
	 * of detailed toString() operation.
	 */
	public static final String ENABLE_DETAILED_TO_STRING = "switch.gen.enable.detailed.toString";

	/**
	 * Constant defines the name of the system property that enables legacy
	 * builder style.
	 */
	public static final String ENABLE_LEGACY_BUILDER_STYLE = "switch.gen.enable.legacy.builder.style";

	/**
	 * Constant defines then name of the system property that enables generation
	 * of an additional builder method with all mandatory fields.
	 */
	public static final String GENERATE_BUILDER_METHOD_WITH_ALL_MANDATORY_FIELDS = "switch.gen.enable.builder.for.manadatory.fields";

	/**
	 * Constant defines the name of the system property which enables the
	 * generation of JUnit tests for services.
	 */
	...
	/**
	 * Constant defines the name of the system property which enables YAML 1.1
	 * compatibility mode for OpenAPI.
	 */
	public static final String OPEN_API_YAML_11_COMPATIBILITY = "switch.gen.openapi.yaml.11.comapitibility";

	/**
	 * Constant defines the name of the system property which defines the
	 * OpenAPI YAML comment style that should be used.
	 */
	public static final String OPEN_API_YAML_COMMENT_STYLE = "switch.gen.openapi.openAPICommentStyle";

	/**
	 * Constant defines the name of the system property which enable that
	 * technical http headers will be suppressed.
	 */
	public static final String SUPPRESS_TECHNICAL_HTTP_HEADERS = "switch.gen.rest.suppress.technical.headers";

	/**
	 * Constant defines the name of the property which enables that ignorable
	 * headers are added to OpenAPI spec
	 */
	public static final String ADD_IGNORED_HEADER_TO_OPEN_API_SPEC = "switch.gen.openapi.addIgnoredHeadersToOpenAPISpec";

	/**
	 * Constant defines the name of the system property which enables the
	 * generation of JAX-RS annotations.
	 */
	public static final String JAX_RS_ANNOTATIONS_PROPERTY = "switch.gen.jaxrs.annotations";

	/**
	 * Constant defines the name of the system property which enables the
	 * generation of Jackson annotations (required for proper JSON
	 * serialization).
	 */
	public static final String JACKSON_ANNOTATIONS_PROPERTY = "switch.gen.jackson.annotations";

	/**
	 * Constant defines the name of the system property which enables SemVer
	 * support for generated JSON serialization.
	 */
	public static final String ENABLE_SEMVER_FOR_JSON = "switch.gen.enable.json.semver";

	/**
	 * Constant defines the name of the system property which enables code
	 * generation for JSON serializers.
	 */
	...
	/**
	 * Method recursively resolves all attributes of the passed class from the
	 * whole inheritance hierarchy.
	 * 
	 * @param pClass
	 *            UML Class object whose attributes should be resolved. The
	 *            parameter must not be null.
	 * @return List All attributes of the passed class. The method never returns
	 *         null.
	 */
	...
	/**
	 * Method checks whether the passed child class is assignable to the passed
	 * class.
	 * 
	 * @param pChild
	 *            Child class for which the check will be performed. The
	 *            parameter must not be null.
	 * @param pClass
	 *            Class to check against. The parameter must not be null.
	 * @return boolean The method returns true if pChild is assignable to
	 *         references of type pClass and false in all other cases.
	 */
	...
	/**
	 * Method checks whether the passed property can be used as a valid init
	 * value.
	 * 
	 * @param pProperty
	 *            Property that should be checked if it has a real init value.
	...
	/**
	 * Method checks whether the passed package is part of the package white
	 * list for generation.
	 * 
	 * @param pPackage
	 *            Package for which should be checked if it is part of the white
	 *            list. The parameter must not be null.
	 * @return boolean The method returns true if the passed package belongs to
	 *         the package white list and false in all other cases.
	 */
	...
	/**
	 * Method checks whether the custom constraint for Java validation from the
	 * UML model should be generated or not.
	 * 
	 * @return boolean Method returns true if custom validations should be
	 *         generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether services from the UML model should be generated or
	 * not.
	 * 
	 * @return boolean Method returns true if public parts should be generated
	 *         from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether service proxies from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if public parts should be generated
	 *         from the model and false in all other cases.
	...
	/**
	 * Method checks whether service provider interfaces from the UML model
	 * should be generated or not.
	 * 
	 * @return boolean Method returns true if service provider interfaces should
	 *         be generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether activity interfaces from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if activity interfaces should be
	 *         generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether activity implementations from the UML model should
	 * be generated or not.
	 * 
	 * @return boolean Method returns true if activity implementations should be
	 *         generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether service objects from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if public parts should be generated
	 *         from the model and false in all other cases.
	...
	/**
	 * Method checks whether POJOs from the UML model should be generated or
	 * not.
	 * 
	 * @return boolean Method returns true if POJOs should be generated from the
	 *         model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether exception classes from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if exception classes should be
	 *         generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether object mappers from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if object mappers should be generated
	 *         from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether component implementation classes from the UML model
	 * should be generated or not.
	 * 
	 * @return boolean Method returns true if component implementation classes
	 *         should be generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether component runtime classes from the UML model should
	 * be generated or not.
	 * 
	 * @return boolean Method returns true if component runtime classes should
	 *         be generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether the global parts from the UML model should be
	 * generated or not.
	 * 
	 * @return boolean Method returns true if global parts should be generated
	 *         from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether JUnit test should be generated for every service or
	 * not.
	 * 
	 * @return boolean Method returns true if JUnit tests should be generated
	 *         from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether OpenAPI specification should be generated for every
	 * service or not.
	 * 
	 * @return boolean Method returns true if OpenAPI spec should be generated
	 *         from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether YAML 1.1 compatibility mode for OpenAPI should be
	 * enabled.
	 * 
	 * @return boolean Method returns true if YAML 1.1 compatibility mode should
	 *         be enabled and false in all other cases.
	 */
	...
	/**
	 * Method checks if ignorable http headers should anyways be added to the
	 * OpenAPI spec.
	 */
	 ...
	 * 
	 * @return boolean Method returns true if JAX-RS Annotations should be
	 *         generated from the model and false in all other cases.
	 */
	...
	/**
	 * Method checks whether Jackson Annotations for (JSON serialization) should
	 * be generated.
	 * 
	 * @return boolean Method returns true if Jackson Annotations should be
	 *         generated from the model and false in all other cases.
	 */
	...
	public static boolean generateNullChecksForToOneAssociationsOfServiceObjects() {
		return SystemProperties.getBooleanProperty(GENERATE_NULL_CHECKS_FOR_TO_ONE_ASSOCIATIONS_OF_SERVICE_OBJECTS,
				true);
	}
		...
		if (GeneratorCommons.shouldStereotypeBeChecked(pStereotype) == true
			...
			if (pStereotype.length() > 0) {
				if (pElement instanceof Class || pElement instanceof Interface || pElement instanceof Component
						|| pElement instanceof Artifact || pElement instanceof Enumeration
						|| pElement instanceof EnumerationLiteral || pElement instanceof Activity
						|| pElement instanceof Dependency || pElement instanceof Operation
					...
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_APPLICATION_EXCEPTION);
					// lRunChecks = lRunChecks |
					// ClassUtil.isStereotypeApplied(lOwner,
					// ClassUtil.STEREOTYPE_COMPONENT);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_DOMAIN_OBJECT);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_JEAF_ENUMERATION);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement.getOwner(), ClassUtil.STEREOTYPE_JEAF_ENUMERATION);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_JEAF_SERVICE);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_LOAD_STRATEGY);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_PERSISTENT_OBJECT);
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_POJO);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_QUERY_OBJECT);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_SERVICE_OBJECT);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_SERVICE_PROVIDER);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_SERVICE_PROVIDER_IMPL);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_SYSTEM_EXCEPTION);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_SYSTEM_EXCEPTION);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_PERSISTENCE_UNIT);
					lRunChecks = lRunChecks
							| ClassUtil.isStereotypeApplied(pElement, ClassUtil.STEREOTYPE_OBJECT_MAPPING);
					...
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, "BeanParam");
					...
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, "MavenProject");
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, "MavenDependency");
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, "MavenProjectDependency");
					lRunChecks = lRunChecks | ClassUtil.isStereotypeApplied(pElement, "MavenParentPOM");
				}
			} else {
				lRunChecks = true;
			}
	...
	public static String getMessage(NamedElement pElement, String pErrorCode, List<String> pParams) {
		...
		if (lElementName == null || lElementName.isEmpty() || lElementName.equals("unknown")) {
			lElementName = "unnamed " + pElement.getClass().getSimpleName() + " in package "
