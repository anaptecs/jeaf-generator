...
public class StringCode {
   ...
   * @return {@link StringCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static StringCode valueOf( String pCode ) {
