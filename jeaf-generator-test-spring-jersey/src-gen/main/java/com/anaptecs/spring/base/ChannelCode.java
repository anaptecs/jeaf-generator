...
public class ChannelCode {
   ...
   * @return {@link ChannelCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static ChannelCode valueOf( String pCode ) {
