...
public class DoubleCodeType {
   ...
   * @return {@link DoubleCodeType} Instance of the class that matches to the passed string. The method never returns
   * null.
   */
  public static DoubleCodeType valueOf( String pCode ) {
    return builder().setCode(Double.parseDouble(pCode)).build();
  }
