...
public class FloatCode {
   ...
   * @return {@link FloatCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static FloatCode valueOf( String pCode ) {
    return builder().setCode(Float.valueOf(pCode)).build();
  }
