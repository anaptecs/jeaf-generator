...
public class ShortCode {
   ...
   * @return {@link ShortCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static ShortCode valueOf( String pCode ) {
    return builder().setCode(Short.valueOf(pCode)).build();
  }
