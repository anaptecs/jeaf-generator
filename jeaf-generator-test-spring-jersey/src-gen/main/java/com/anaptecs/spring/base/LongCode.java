...
public class LongCode {
   ...
   * @return {@link LongCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static LongCode valueOf( String pCode ) {
    return builder().setCode(Long.valueOf(pCode)).build();
  }
