...
public class ByteCodeType {
   ...
   * @return {@link ByteCodeType} Instance of the class that matches to the passed string. The method never returns
   * null.
   */
  public static ByteCodeType valueOf( String pCode ) {
    return builder().setCode(Byte.parseByte(pCode)).build();
  }
