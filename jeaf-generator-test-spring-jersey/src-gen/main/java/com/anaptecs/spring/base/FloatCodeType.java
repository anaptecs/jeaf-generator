...
public class FloatCodeType {
   ...
   * @return {@link FloatCodeType} Instance of the class that matches to the passed string. The method never returns
   * null.
   */
  public static FloatCodeType valueOf( String pCode ) {
    return builder().setCode(Float.parseFloat(pCode)).build();
  }
