...
public class BooleanCode {
   ...
   * @return {@link BooleanCode} Instance of the class that matches to the passed string. The method never returns null.
   */
  public static BooleanCode valueOf( String pCode ) {
    return builder().setCode(Boolean.valueOf(pCode)).build();
  }
