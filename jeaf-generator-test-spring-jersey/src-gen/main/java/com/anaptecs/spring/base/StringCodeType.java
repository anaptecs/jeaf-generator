...
public class StringCodeType {
   ...
   * @return {@link StringCodeType} Instance of the class that matches to the passed string. The method never returns
   * null.
   */
  public static StringCodeType valueOf( String pCode ) {
