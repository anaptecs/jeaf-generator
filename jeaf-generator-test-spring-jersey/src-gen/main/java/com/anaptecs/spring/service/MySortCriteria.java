...
public class MySortCriteria extends MySortCriteriaBase {
   ...
   *
   * @param pSortOrder String that should be used to create an instance of this class. The parameter must not be null.
   * @return {@link MySortCriteria} Instance of the class that matches to the passed string. The method never returns
   * null.
   */
  public static MySortCriteria valueOf( String pSortOrder ) {
    return builder().setSortOrder(SortOrder.valueOf(pSortOrder)).build();
  }
