...
public class SpringRESTControllerTest {
  ...
  void testBeanQueryParamDateConversions( ) {
    ...
    restProductService.testDateQueryParamsBean("1", lBuilder.build());
    ...
    lBuilder.setSqlTime(lSQLTime);
    lBuilder.setSqlDate(lSQLDate);
    restProductService.testDateQueryParamsBean("2", lBuilder.build());
    ...
    lBuilder.setSqlTime(lSQLTime);
    lBuilder.setSqlDate(lSQLDate);
    restProductService.testDateQueryParamsBean("3", lBuilder.build());
