...
public class IgnoringClass implements ServiceObject {
   ...
   */
  public static Builder builder( String pIgnoredName, int pIgnoredPrimitive, Integer pAge ) {
    Builder lBuilder = builder();
    lBuilder.setIgnoredName(pIgnoredName);
    lBuilder.setIgnoredPrimitive(pIgnoredPrimitive);
