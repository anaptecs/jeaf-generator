 ...
 */
public class DataTypeWithConstraintsSerializer extends JsonSerializer<DataTypeWithConstraints> {
  @Override
  public void serialize( DataTypeWithConstraints pObject, JsonGenerator pGenerator, SerializerProvider pSerializers )
    throws IOException {
