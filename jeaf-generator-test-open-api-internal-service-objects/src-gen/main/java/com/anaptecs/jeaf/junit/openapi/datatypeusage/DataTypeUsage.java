...
public class DataTypeUsage implements ServiceObject {
   ...
   */
  public static Builder builder( MyDataType pCode ) {
  ...
  public int hashCode( ) {
    ...
    lResult = lPrime * lResult + Objects.hashCode(codes);
    return lResult;
  }
  ...
  public boolean equals( Object pObject ) {
    ...
    if (this == pObject) {
      ...
      DataTypeUsage lOther = (DataTypeUsage) pObject;
      lEquals = Objects.equals(code, lOther.code) && Objects.equals(codes, lOther.codes);
    }
    return lEquals;
  }
