...
public class DiscountOffer implements ServiceObject {
  ...
  protected DiscountOffer( Builder pBuilder ) {
    ...
    campaigns = (pBuilder.campaigns == null) ? new HashSet<>() : pBuilder.campaigns;
  }
  ...
  public int hashCode( ) {
    final int lPrime = 31;
    int lResult = 1;
    lResult = lPrime * lResult + Objects.hashCode(campaigns);
    return lResult;
  }
  ...
  public boolean equals( Object pObject ) {
    ...
    if (this == pObject) {
      ...
      DiscountOffer lOther = (DiscountOffer) pObject;
      lEquals = Objects.equals(campaigns, lOther.campaigns);
    }
    return lEquals;
  }
