...
public abstract class MyPOJOResponseBase {
  ...
  /**
   * <p/>
   * <b>Breaking Change</b> (<b>since:</b> TBD, <b>active with:</b> 7.0, <b>activation date:</b> 2026-12-24):
   */
  ...
  public static abstract class BuilderBase {
    ...
    public BuilderBase setUntouchedProperty( @MyNotNullProperty String pUntouchedProperty ) {
