...
public class Stop {
   ...
   *
   * @return {@link StopBuilder} New builder that can be used to create new Stop objects.
   */
   ...
   *
   * @return {@link StopBuilder} New builder that can be used to create new Stop objects. The method never returns null.
   */
