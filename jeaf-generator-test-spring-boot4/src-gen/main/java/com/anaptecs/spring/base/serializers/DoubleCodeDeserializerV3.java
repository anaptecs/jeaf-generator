 ...
 */
public class DoubleCodeDeserializerV3 extends ValueDeserializer<DoubleCode> {
  @Override
  public DoubleCode deserialize( JsonParser pParser, DeserializationContext pContext ) {
    // Parse JSON content.
    ...
    // Node is not of expected type.
      ...
      throw DatabindException.from(pContext,
          "Unable to deserialize object of type DoubleCode. Expected node type that matches to data type but received other JSON content. Current JSON node ''"
