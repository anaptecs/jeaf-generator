...
public class BusinessA extends TechParent {
   ...
   *
   * @return {@link BusinessABuilder} New builder that can be used to create new BusinessA objects.
   */
  ...
  public static abstract class BusinessABuilder<T extends BusinessA, B extends BusinessABuilder<T, B>>
     ...
     */
    public B setBusinessAttribute( int pBusinessAttribute ) {
   ...
   *
   * @return {@link BusinessABuilder} New builder that can be used to create new BusinessA objects. The method never
   * returns null.
   */
