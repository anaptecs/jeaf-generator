 ...
 */
public class IntegerCodeDeserializerV3 extends ValueDeserializer<IntegerCode> {
  @Override
  public IntegerCode deserialize( JsonParser pParser, DeserializationContext pContext ) {
    // Parse JSON content.
