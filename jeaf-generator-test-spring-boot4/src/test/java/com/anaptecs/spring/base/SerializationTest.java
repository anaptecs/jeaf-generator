...
public class SerializationTest {
  private ObjectMapper objectMapper = ObjectMapperFactoryV3.createObjectMapper(new KryoCompositeTypeConverter());
  ...
  @Test
  void testExtensibleEnumSerialization( ) {
  ...
  @Test
  void testJSONBackwardCompatibility( ) {
  ...
  @Test
  void testByteBufferSerialization( ) {
