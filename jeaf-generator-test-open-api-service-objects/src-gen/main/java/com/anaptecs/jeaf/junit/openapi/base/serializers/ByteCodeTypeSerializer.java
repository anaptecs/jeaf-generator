 ...
 */
public class ByteCodeTypeSerializer extends JsonSerializer<ByteCodeType> {
  @Override
  public void serialize( ByteCodeType pObject, JsonGenerator pGenerator, SerializerProvider pSerializers )
    throws IOException {
