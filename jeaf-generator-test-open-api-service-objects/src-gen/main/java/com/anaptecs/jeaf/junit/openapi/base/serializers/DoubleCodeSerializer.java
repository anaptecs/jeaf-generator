 ...
 */
public class DoubleCodeSerializer extends JsonSerializer<DoubleCode> {
  @Override
  public void serialize( DoubleCode pObject, JsonGenerator pGenerator, SerializerProvider pSerializers )
    throws IOException {
