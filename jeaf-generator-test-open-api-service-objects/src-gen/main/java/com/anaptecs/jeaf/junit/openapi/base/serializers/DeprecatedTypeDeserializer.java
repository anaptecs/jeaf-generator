 ...
 */
public class DeprecatedTypeDeserializer extends JsonDeserializer<DeprecatedType> {
  @Override
  public DeprecatedType deserialize( JsonParser pParser, DeserializationContext pContext ) throws IOException {
    // Parse JSON content.
