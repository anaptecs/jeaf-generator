 ...
 * target.
 */
public class ChildPOJOToBChildPOJOConverter implements ObjectMapper<ChildPOJO, BChildPOJO> {
  /**
   ...
   */
  public static List<BChildPOJO> createNewTargetObjects( Collection<ChildPOJO> pSourceObjects ) {
    // Check parameter
   ...
   */
  @Override
  public void applyMappings( List<ChildPOJO> pSources, List<BChildPOJO> pTargets,
    ...
    Iterator<ChildPOJO> lSourceIterator = pSources.iterator();
   ...
   */
  public static List<ChildPOJO> createNewSourceObjects( Collection<BChildPOJO> pTargetObjects ) {
    // Check parameter
    Check.checkInvalidParameterNull(pTargetObjects, "pTargetObjects");
    // Create new source object for every passed target object.
    List<ChildPOJO> lNewObjects = new ArrayList<ChildPOJO>(pTargetObjects.size());
