...
public class ValidationGroupHelper {
   ...
   */
  public static Optional<ValidationGroup> findMatchingValidationGroup( String pVersionName ) {
   ...
   * @return {@link Optional<ValidationGroup>} First validation group that matches if any does.
   */
  public static Optional<ValidationGroup> findMatchingValidationGroup( Predicate<ValidationGroup> pPredicate ) {
