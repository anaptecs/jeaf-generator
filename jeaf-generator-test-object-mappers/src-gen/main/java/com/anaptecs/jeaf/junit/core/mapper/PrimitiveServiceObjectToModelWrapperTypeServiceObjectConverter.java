...
import com.anaptecs.jeaf.junit.core.ModelWrapperTypeServiceObject;
 ...
 * {@link ModelWrapperTypeServiceObject} as target.
 */
public class PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter
    implements ObjectMapper<PrimitiveServiceObject, ModelWrapperTypeServiceObject> {
  /**
   * Only instance of this class. We can avoid to create multiple instances as object mapper implementations are
   * stateless and thread safe.
   */
  private static final PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter INSTANCE =
      new PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter();

  /**
   * Constructor is private. In order to avoid that unnecessary instances are created.
   */
  private PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter( ) {
  }
   ...
   * ModelWrapperTypeServiceObject. The method never returns null.
   */
  public static PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter getConverter( ) {
    return INSTANCE;
  }

  /**
   * Method creates a new ModelWrapperTypeServiceObject object from the passed PrimitiveServiceObject object and applies
   * the defined mappings of type {@link MappingType#CREATE} from the UML model.
   * 
   * @param pSource PrimitiveServiceObject object that should be used to create a new ModelWrapperTypeServiceObject
   * object. The parameter must not be null.
   * @return {@link ModelWrapperTypeServiceObject} Created ModelWrapperTypeServiceObject object. The method never
   * returns null.
   */
  public static ModelWrapperTypeServiceObject createNewTargetObject( PrimitiveServiceObject pSource ) {
    // Check parameter
    Check.checkInvalidParameterNull(pSource, "pSource");
    // Create new target object.
    ModelWrapperTypeServiceObject lTarget = ModelWrapperTypeServiceObject.Builder.newBuilder().build();
    PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter lObjectMapper =
        PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter.getConverter();
  ...
  /**
   * Method creates new ModelWrapperTypeServiceObject objects based on the passed PrimitiveServiceObject objects. For
   * every PrimitiveServiceObject object a new ModelWrapperTypeServiceObject object will be returned. The mappings for
   * case {@link MappingType#CREATE} will be applied.
   * 
   * @param pSourceObjects All PrimitiveServiceObject objects that should be used to create
   * ModelWrapperTypeServiceObject objects. The parameter must not be null.
   * @return {@link List} List with all ModelWrapperTypeServiceObject objects that were created. The method never
   * returns null.
   */
  public static List<ModelWrapperTypeServiceObject> createNewTargetObjects(
    ...
    List<ModelWrapperTypeServiceObject> lTargetObjects =
        new ArrayList<ModelWrapperTypeServiceObject>(pSourceObjects.size());
    for (PrimitiveServiceObject lNext : pSourceObjects) {
      ModelWrapperTypeServiceObject lNewTargetObject =
          PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter.createNewTargetObject(lNext);
   ...
   */
  @Override
  public void applyMappings( PrimitiveServiceObject pSource, ModelWrapperTypeServiceObject pTarget,
   ...
   */
  @Override
  public void applyMappings( List<PrimitiveServiceObject> pSources, List<ModelWrapperTypeServiceObject> pTargets,
      ObjectMapper.MappingType pMappingType ) {
    // Check parameters
    ...
    Iterator<ModelWrapperTypeServiceObject> lTargetIterator = pTargets.iterator();
   ...
   * 
   * @param pTarget ModelWrapperTypeServiceObject object that should be used to create a new PrimitiveServiceObject
   * object. The parameter must not be null.
   * @return {@link PrimitiveServiceObject} Created PrimitiveServiceObject object. The method never returns null.
   */
  public static PrimitiveServiceObject createNewSourceObject( ModelWrapperTypeServiceObject pTarget ) {
    // Check parameter
    Check.checkInvalidParameterNull(pTarget, "pTarget");
  ...
  /**
   * Method creates new PrimitiveServiceObject objects based on the passed ModelWrapperTypeServiceObject objects. For
   * every ModelWrapperTypeServiceObject object a new PrimitiveServiceObject object will be returned. The mappings for
  ...
  public static List<PrimitiveServiceObject> createNewSourceObjects(
      Collection<ModelWrapperTypeServiceObject> pTargetObjects ) {
    // Check parameter
    ...
    for (ModelWrapperTypeServiceObject lNext : pTargetObjects) {
      PrimitiveServiceObject lNewSourceObject =
          PrimitiveServiceObjectToModelWrapperTypeServiceObjectConverter.createNewSourceObject(lNext);
  ...
  /**
   * Method maps all attributes from PrimitiveServiceObject to ModelWrapperTypeServiceObject. Mappings are applied only
  ...
  /**
   * Method maps all attributes from ModelWrapperTypeServiceObject to PrimitiveServiceObject. Mappings are applied only
   * for case {@link MappingType#READ}.
   * 
   * @param pSource Source object for the mapping. The parameter must not be null.
   * @param pTarget Target object for the mapping. The parameter must not be null.
