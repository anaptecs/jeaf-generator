...
public final class MyMessages {
  ...
  /**
   * Constant for label "Welcome".
   */
  public static final LocalizedString WELCOME_LABEL;

  /**
   * Constant for label "IBAN".
   */
  public static final LocalizedString IBAN_LABEL;

  /**
   * Constant for label at end of mail
   */
  public static final LocalizedString BEST_REGARDS;
  /**
  ...
  static {
    ...
    LOCALIZED_MESSAGE = lRepository.getLocalizedString(20009);
    DEPRECATED_LOCALIZED_MESSAGE = lRepository.getLocalizedString(20010);
    WELCOME_LABEL = lRepository.getLocalizedString(30000);
    IBAN_LABEL = lRepository.getLocalizedString(30001);
    BEST_REGARDS = lRepository.getLocalizedString(30002);
  }
