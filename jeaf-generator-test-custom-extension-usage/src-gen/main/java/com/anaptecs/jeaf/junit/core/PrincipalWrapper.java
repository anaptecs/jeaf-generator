...
public class PrincipalWrapper extends Object implements ServiceObject {
  /**
  ...
  protected PrincipalWrapper( Builder pBuilder ) {
    ...
    // "java.security.Principal"
    lPrincipalXYZ = pBuilder.lPrincipalXYZ;
  }
  ...
  public static class Builder {
    ...
    protected Builder( PrincipalWrapper pObject ) {
      if (pObject != null) {
        ...
        this.setLPrincipal(pObject.lPrincipal);
      }
    }
    ...
    public Builder setLPrincipalXYZ( int value ) {
      // "java.security.Principal"
      lPrincipalXYZ = value;
      return this;
    }
  ...
  public int getLPrincipalXYZ( ) {
    // "java.security.Principal"
    return lPrincipalXYZ;
  }

  public void setLPrincipalXYZ( int value ) {
    lPrincipalXYZ = value;
  }
