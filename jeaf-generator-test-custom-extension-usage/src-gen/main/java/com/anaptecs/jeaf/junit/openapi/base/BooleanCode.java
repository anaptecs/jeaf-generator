...
public class BooleanCode extends Object implements ServiceObject {
  /**
  ...
  public static class Builder {
    ...
    /**
     * Method creates a new validated instance of class BooleanCode. The object will be initialized with the values of
     * the builder and validated afterwards.
     *
     * @return BooleanCode Created and validated object. The method never returns null.
     * @throws ConstraintViolationException in case that one or more validations for the created object failed.
     */
    public BooleanCode buildValidated( ) throws ConstraintViolationException {
      BooleanCode lObject = this.build();
