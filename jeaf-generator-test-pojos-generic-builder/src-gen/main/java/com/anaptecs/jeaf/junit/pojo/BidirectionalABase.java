...
public abstract class BidirectionalABase {
  ...
  public static abstract class BidirectionalABuilder<T extends BidirectionalA, S extends BidirectionalABuilder<T, S>> {
     ...
     */
    public S setChild( BidirectionalA pChild ) {
      child = pChild;
      return this.self();
    }
