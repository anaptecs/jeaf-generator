...
public class PrimitiveArraysObject {
   ...
   */
  public static PrimitiveArraysObject of( boolean[] pABooleanArray, Boolean[] pBBooleanArray, boolean[] pCBooleanArray,
      byte[] pAByteArray, Byte[] pBByteArray, short[] pAShortArray, Short[] pBShortArray, int[] pAIntegerArray,
      Integer[] pBIntegerArray, Integer[] pCIntegerArray, long[] pALongArray, Long[] pBLongArray,
      ...
      String[] pAStringArray, String[] pBStringArray, String[] pCStringArray ) {
