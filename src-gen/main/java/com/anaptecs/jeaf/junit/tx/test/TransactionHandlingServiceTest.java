...
/**
 * This class implements the test suite for service TransactionHandlingService.
 */
public class TransactionHandlingServiceTest extends TransactionHandlingServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TransactionHandlingServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TransactionHandlingServiceTest("testTestIndirectInvocations"));
   ...
   */
  public TransactionHandlingServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TransactionHandlingServiceTest( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testTestIndirectInvocations( ) throws Exception {
    // TODO Implement test for service method testIndirectInvocations(...)
  }
}