...
/**
 * This class implements the test suite for service TxSupportedService.
 */
public class TxSupportedServiceTest extends TxSupportedServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxSupportedServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxSupportedServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxSupportedServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxSupportedServiceTest( String pName, String pUserId, String pPassword ) {
