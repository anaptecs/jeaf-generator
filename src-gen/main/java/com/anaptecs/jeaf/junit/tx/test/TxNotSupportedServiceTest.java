...
/**
 * This class implements the test suite for service TxNotSupportedService.
 */
public class TxNotSupportedServiceTest extends TxNotSupportedServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxNotSupportedServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxNotSupportedServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxNotSupportedServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxNotSupportedServiceTest( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testTestTransactionBehavior( ) throws Exception {
    // TODO Implement test for service method testTransactionBehavior(...)
  }
}