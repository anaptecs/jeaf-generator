...
/**
 * This is the base class of the test suite of service TxNotSupportedService.
 * 
 * @version $LastChangedRevision: 931 $
 */
public abstract class TxNotSupportedServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected TxNotSupportedService txNotSupportedService;
   ...
   */
  public TxNotSupportedServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public TxNotSupportedServiceTestBase( String pName, String pUserId, String pPassword ) {
