...
/**
 * This is the base class of the test suite of service JEAFSecurityTestService.
 * 
 * @version $LastChangedRevision: 931 $
 */
public abstract class JEAFSecurityTestServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected JEAFSecurityTestService jEAFSecurityTestService;
   ...
   */
  public JEAFSecurityTestServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public JEAFSecurityTestServiceTestBase( String pName, String pUserId, String pPassword ) {
   ...
   */
  public abstract void testCheckCurrentUser( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testCheckCurrentAnonymousUser( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testCheckInvalidServiceAccess( ) throws Exception;
}