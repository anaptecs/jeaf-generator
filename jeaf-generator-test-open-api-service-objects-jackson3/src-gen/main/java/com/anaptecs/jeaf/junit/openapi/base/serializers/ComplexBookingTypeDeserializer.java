 ...
 */
public class ComplexBookingTypeDeserializer extends ValueDeserializer<ComplexBookingType> {
  @Override
  public ComplexBookingType deserialize( JsonParser pParser, DeserializationContext pContext ) {
    ...
    // Node is not a TextNode
      ...
      throw new JEAFSystemException(JSONMessages.UNEXPECTED_NODE_TYPE_FOR_DESERIALIZATION,
          ComplexBookingType.class.getName(), lNode.toString(), lNode.getClass().getName());
    }
  }
}