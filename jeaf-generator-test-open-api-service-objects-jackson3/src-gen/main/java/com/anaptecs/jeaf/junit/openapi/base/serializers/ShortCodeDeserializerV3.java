 ...
 */
public class ShortCodeDeserializerV3 extends ValueDeserializer<ShortCode> {
  @Override
  public ShortCode deserialize( JsonParser pParser, DeserializationContext pContext ) {
    ...
    // Node is not of expected type.
      ...
      throw new JEAFSystemException(JSONMessages.UNEXPECTED_NODE_TYPE_FOR_DESERIALIZATION, ShortCode.class.getName(),
