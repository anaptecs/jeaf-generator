 ...
 */
public class DataUnitSerializer extends JsonSerializer<DataUnit> {
  @Override
  public void serialize( DataUnit pObject, JsonGenerator pGenerator, SerializerProvider pSerializers )
    throws IOException {
