 ...
 */
public class InlineSortimentTypeDeserializerV3 extends ValueDeserializer<InlineSortimentType> {
  @Override
  public InlineSortimentType deserialize( JsonParser pParser, DeserializationContext pContext ) {
    // Parse JSON content.
