 ...
 */
@ModuleFactory
public class TransientModuleFactoryV3 implements ObjectMapperModuleFactory {
  /**
  ...
  public JacksonModule createModule( ) {
    ...
    SimpleModule lModule = new SimpleModule(TransientModuleFactoryV3.class.getName());
  ...
  public static JacksonModule createDataTypeSerializerModule( ) {
    // Create module for serializers / deserializers that are located in this package
    SimpleModule lModule = new SimpleModule("DataTypeSerializerModule." + TransientModuleFactoryV3.class.getName());
  ...
  public static JacksonModule createEnumSerializerModule( ) {
    // Create module for serializers / deserializers that are located in this package
    SimpleModule lModule = new SimpleModule("EnumSerializerModule." + TransientModuleFactoryV3.class.getName());
    // Add serializers and deserializers for enumerations
    // Return created module.
    return lModule;
  }
