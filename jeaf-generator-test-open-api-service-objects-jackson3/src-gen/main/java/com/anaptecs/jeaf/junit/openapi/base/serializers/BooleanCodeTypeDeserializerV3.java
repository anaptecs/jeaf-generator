 ...
 */
public class BooleanCodeTypeDeserializerV3 extends ValueDeserializer<BooleanCodeType> {
  @Override
  public BooleanCodeType deserialize( JsonParser pParser, DeserializationContext pContext ) {
    ...
    // Node is not of expected type.
      ...
      throw new JEAFSystemException(JSONMessages.UNEXPECTED_NODE_TYPE_FOR_DESERIALIZATION,
          BooleanCodeType.class.getName(), lNode.toString(), lNode.getClass().getName());
    }
  }
}