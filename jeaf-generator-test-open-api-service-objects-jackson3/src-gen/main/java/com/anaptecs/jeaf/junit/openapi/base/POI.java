...
public class POI extends Stop {
  ...
  /**
   * <p/>
   * <b>Breaking Change</b> (<b>since:</b> TBD, <b>active with:</b> 2024-12-24, <b>go live date:</b> TBD): New mandatory
   * association is required to support upcoming features.
   */
  @Size(min = 2, max = 42)
  @NotNull
  @JsonSetter(nulls = Nulls.SKIP)
  ...
  protected POI( Builder pBuilder ) {
    ...
    evenMoreLinkIDs = (pBuilder.evenMoreLinkIDs == null) ? new HashSet<>() : pBuilder.evenMoreLinkIDs;
  ...
  public static class Builder extends Stop.Builder {
    ...
    /**
     * <p/>
     * <b>Breaking Change</b> (<b>since:</b> TBD, <b>active with:</b> 2024-12-24, <b>go live date:</b> TBD): New
