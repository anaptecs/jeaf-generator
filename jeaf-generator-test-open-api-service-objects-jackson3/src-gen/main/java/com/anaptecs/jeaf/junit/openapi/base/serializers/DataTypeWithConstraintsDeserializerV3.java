 ...
 */
public class DataTypeWithConstraintsDeserializerV3 extends ValueDeserializer<DataTypeWithConstraints> {
  @Override
  public DataTypeWithConstraints deserialize( JsonParser pParser, DeserializationContext pContext ) {
    // Parse JSON content.
