 ...
 */
public class BigIntegerCodeDeserializerV3 extends ValueDeserializer<BigIntegerCode> {
  @Override
  public BigIntegerCode deserialize( JsonParser pParser, DeserializationContext pContext ) {
    // Parse JSON content.
