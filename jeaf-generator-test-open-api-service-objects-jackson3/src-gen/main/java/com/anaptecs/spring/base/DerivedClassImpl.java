...
@Valid
@JsonDeserialize(builder = DerivedClassImpl.Builder.class)
public class DerivedClassImpl extends AbtractWithDerivedProperty {
  ...
  public static class Builder extends AbtractWithDerivedProperty.Builder {
     ...
     */
    public Builder setDerivedProperty( @MyNotNullProperty String pDerivedProperty ) {
    ...
    /**
     * Method creates a new validated instance of class DerivedClassImpl. The object will be initialized with the values
     * of the builder and validated afterwards.
     *
     * @return DerivedClassImpl Created and validated object. The method never returns null.
     * @throws ConstraintViolationException in case that one or more validations for the created object failed.
     */
    public DerivedClassImpl buildValidated( ) throws ConstraintViolationException {
      DerivedClassImpl lObject = this.build();
