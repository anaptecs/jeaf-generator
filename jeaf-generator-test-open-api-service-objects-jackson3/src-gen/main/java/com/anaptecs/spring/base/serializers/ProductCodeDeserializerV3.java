 ...
 */
public class ProductCodeDeserializerV3 extends ValueDeserializer<ProductCode> {
  @Override
  public ProductCode deserialize( JsonParser pParser, DeserializationContext pContext ) {
    ...
    // Node is not of expected type.
      ...
      throw new JEAFSystemException(JSONMessages.UNEXPECTED_NODE_TYPE_FOR_DESERIALIZATION, ProductCode.class.getName(),
