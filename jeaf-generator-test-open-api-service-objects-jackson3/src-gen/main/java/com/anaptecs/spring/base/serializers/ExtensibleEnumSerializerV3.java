 ...
 */
public class ExtensibleEnumSerializerV3 extends ValueSerializer<ExtensibleEnum> {
  @Override
  public void serialize( ExtensibleEnum pObject, JsonGenerator pGenerator, SerializationContext pSerializers ) {
