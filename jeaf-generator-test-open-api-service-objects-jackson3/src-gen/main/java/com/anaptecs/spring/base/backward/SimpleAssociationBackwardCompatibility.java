...
public class SimpleAssociationBackwardCompatibility {
  ...
  public static class Builder {
     ...
     * <b>go live date:</b> TBD, <b>end of compatibility period:</b> TBD)
     */
    @Deprecated
    ...
    /**
     * Method creates a new validated instance of class SimpleAssociationBackwardCompatibility. The object will be
     * initialized with the values of the builder and validated afterwards.
     *
     * @return SimpleAssociationBackwardCompatibility Created and validated object. The method never returns null.
     * @throws ConstraintViolationException in case that one or more validations for the created object failed.
     */
    public SimpleAssociationBackwardCompatibility buildValidated( ) throws ConstraintViolationException {
      SimpleAssociationBackwardCompatibility lObject = this.build();
   ...
   * live date:</b> TBD, <b>end of compatibility period:</b> TBD)
   */
  @Deprecated
  @JsonGetter
  ...
  public void addToDeprecatedLinks( Collection<SimpleBackwardCompatibility> pDeprecatedLinks ) {
    // Check parameter "pDeprecatedLinks" for invalid value null.
    Check.checkInvalidParameterNull(pDeprecatedLinks, "pDeprecatedLinks");
  ...
  public List<SimpleBackwardCompatibility> getNewLinks( ) {
    // Return all SimpleBackwardCompatibility objects directly without any protection against modification.
    return newLinks;
  }
  ...
  public void addToNewLinks( SimpleBackwardCompatibility pNewLinks ) {
    // Check parameter "pNewLinks" for invalid value null.
    Check.checkInvalidParameterNull(pNewLinks, "pNewLinks");
