 ...
 */
@Service
public class RESTProductServiceRESTProxyReactive implements RESTProductServiceReactive {
  /**
   ...
   */
  private final RESTRequestExecutorReactive requestExecutor;
  ...
  public Mono<List<Product>> getProducts( int pMaxResultSize ) {
    ...
    return validationExecutor.validateRequest(RESTProductService.class, pMaxResultSize)
        ...
        // Validate response
        .delayUntil(result -> validationExecutor.validateResponse(RESTProductService.class, result));
  }
  ...
  public Mono<Product> getProduct( String pProductID ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pProductID)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
  ...
  public Mono<Boolean> createProduct( Product pProduct ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pProduct)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
  ...
  public Mono<Sortiment> getSortiment( Context pContext ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pContext)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
  ...
  public Mono<ChannelCode> createChannelCode( String pChannelCode ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pChannelCode)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for POST request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<List<CurrencyCode>> getSupportedCurrencies( ChannelCode pChannelCode ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pChannelCode)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<List<CurrencyCode>> getSupportedCurrenciesAsync( ChannelCode pChannelCode ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pChannelCode)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<String> testParams( BigDecimal pBigDecimalHeader, int pIntCookieParam, Locale pLocaleQueryParam ) {
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pBigDecimalHeader, pIntCookieParam, pLocaleQueryParam)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<Void> testEnumParams( ChannelType pChannelType, TimeUnit pTimeUnit, ExtensibleEnum pExtensibleEnum ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pChannelType, pTimeUnit, pExtensibleEnum)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<Void> testEnumHeaderParams( ChannelType pChannelType, TimeUnit pTimeUnit,
   ...
   */
  @Override
  public Mono<Void> testDateQueryParams( String pPath, OffsetDateTime pStartTimestamp, OffsetTime pStartTime,
    ...
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pPath, pStartTimestamp, pStartTime, pLocalStartTimestamp,
  ...
  public Mono<Void> testDateQueryParamsBean( String pPath, DateQueryParamsBean pQueryParams ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pPath, pQueryParams)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<Void> testDateHeaderParams( String pPath, OffsetDateTime pOffsetDateTime, OffsetTime pOffsetTime,
    ...
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pPath, pOffsetDateTime, pOffsetTime, pLocalDateTime, pLocalTime,
  ...
  public Mono<Void> testDateHeaderParamsBean( String pPath, DateHeaderParamsBean pHeaderParams ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pPath, pHeaderParams)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<Void> testCookieParams( ChannelType pChannelTypeParam, SpecialContext pContext ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pChannelTypeParam, pContext)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testOptionalQueryParams( String query1, int query2 ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, query1, query2)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<Boolean> processComplexBookingID( ComplexBookingID pComplextBookingID ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pComplextBookingID)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
  ...
  public Mono<String> testDataTypesAsHeaderParam( BookingID pBookingID, BookingCode pBookingCode,
    ...
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBookingID, pBookingCode, pDoubleCode)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testDataTypesAsHeaderBeanParam( AdvancedHeader pContext ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pContext)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<String> testPrimitiveArrays( int[] pIntegerArray ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pIntegerArray)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for POST request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testDataTypeAsQueryParam( BookingCode pBookingCode ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBookingCode)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testDataTypeAsBeanQueryParam( QueryBeanParam pBeanParam ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBeanParam)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testPrimitiveArrayAsQueryParam( int[] pIntValues ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pIntValues)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testSimpleTypesAsQueryParams( List<String> pStrings ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pStrings)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testPrimitiveWrapperArrayAsQueryParam( Set<Integer> pIntegers ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pIntegers)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testMultivaluedQueryParamsBean( MultivaluedQueryParamsBean pBean ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBean)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testMulitvaluedDataTypeAsQueryParam( List<IntegerCodeType> pCodes, Set<LongCode> pLongCodes,
      List<BookingID> pBookingIDs, List<OffsetDateTime> pTimestamps, SortedSet<LocalDate> pLocalDates ) {
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pCodes, pLongCodes, pBookingIDs, pTimestamps, pLocalDates)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
   ...
   */
  @Override
  public Mono<String> testMulitvaluedDataTypeAsBeanQueryParam( DataTypesQueryBean pQueryBean ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pQueryBean)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
          ...
          if (pQueryBean != null) {
            ...
            if (pQueryBean.getLocalTime() != null) {
              lRequestBuilder.setQueryParameter("localTime",
                  DateTimeFormatter.ISO_TIME.format(pQueryBean.getLocalTime()));
            }
   ...
   */
  @Override
  public Mono<String> testMultiValuedHeaderFieldsInBeanParam( MultiValuedHeaderBeanParam pMultiValuedBean ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pMultiValuedBean)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
          ...
          if (pMultiValuedBean != null) {
            ...
            if (pMultiValuedBean.getStartDate() != null) {
              lRequestBuilder.setHeader("startDate",
                  DateTimeFormatter.ISO_DATE.format(pMultiValuedBean.getStartDate()));
            }
   ...
   */
  @Override
  public Mono<String> testMultiValuedHeaderFields( Set<String> pNames, int[] pInts, Set<Double> pDoubles,
      Set<StringCode> pCodes, OffsetDateTime pStartDate, Set<OffsetDateTime> pTimestamps, Set<OffsetTime> pTimes,
      byte[] pBase64 ) {
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pNames, pInts, pDoubles, pCodes, pStartDate, pTimestamps, pTimes,
            pBase64)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
   ...
   */
  @Override
  public Mono<Void> testBookingIDAsPathParam( BookingID pBookingID ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBookingID)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<Void> testBookingIDAsHeaderParam( BookingID pBookingID ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pBookingID)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<String> testContextWithPrimitives( ContextWithPrimitives pContext ) {
    // Validate request parameter(s).
    return validationExecutor.validateRequest(RESTProductService.class, pContext)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
   ...
   */
  @Override
  public Mono<String> testPrimitivesAsParams( int pAnInt, Integer pAnInteger, boolean pABoolean,
      Boolean pBooleanWrapper, long pALong, Long pVeryLong ) {
    // Validate request parameter(s).
    return validationExecutor
        .validateRequest(RESTProductService.class, pAnInt, pAnInteger, pABoolean, pBooleanWrapper, pALong, pVeryLong)
        // Next, we execute the REST request
        .then(Mono.defer(( ) -> {
          // Create builder for GET request
          RESTRequest.Builder lRequestBuilder =
