...
public class TransientBackReferenceTest {
  ...
  void testTransientBackReferences( ) {
    ...
    assertEquals("com.anaptecs.jeaf.junit.pojo.transientback.MasterClass\r\n" + "clients: 2 element(s)\r\n"
        + "    com.anaptecs.jeaf.junit.pojo.transientback.ClientClass\r\n" + "    name: Client 1\r\n" + "\r\n"
        + "    com.anaptecs.jeaf.junit.pojo.transientback.ClientClass\r\n" + "    name: Client 2\r\n" + "\r\n"
        + "name: Master 1\r\n" + "singleClient:  null\r\n", lAsString);
  ...
  void testTransientBackReferenceForReadonlyClasses( ) {
    ...
    String lAsString = lMaster.toString();
    assertEquals("com.anaptecs.jeaf.junit.pojo.transientback.ReadOnlyMaster\r\n" + "name: Master 1\r\n"
        + "clients: 2 element(s)\r\n" + "    com.anaptecs.jeaf.junit.pojo.transientback.ReadOnlyClient\r\n"
        + "    name: Client 1\r\n" + "\r\n" + "    com.anaptecs.jeaf.junit.pojo.transientback.ReadOnlyClient\r\n"
        + "    name: Client 2\r\n" + "\r\n", lAsString);
