...
public class POJOWithIDnMethod extends POJOWithIDnMethodBase {
  ...
  public static class Builder extends POJOWithIDnMethod.BuilderBase {
    ...
    /**
     * Use {@link #newBuilder(POJOWithIDnMethod)} instead of protected constructor to create new builder.
     */
     ...
     * returns null.
     */
    public static Builder newBuilder( POJOWithIDnMethod pObject ) {
