...
public class ParentPOJO {
  ...
  /**
   * Class implements builder to create a new instance of class ParentPOJO. As the class has readonly attributes or
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "parentAttribute",
        "" + parentAttribute));
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "weirdAttribute",
        "" + weirdAttribute));
    lBuilder.append('\n');
