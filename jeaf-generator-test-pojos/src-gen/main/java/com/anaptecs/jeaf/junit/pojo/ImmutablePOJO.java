...
public class ImmutablePOJO {
  ...
  /**
   * Class implements builder to create a new instance of class ImmutablePOJO. As the class has readonly attributes or
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append('\n');
    lBuilder
        .append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "something", "" + something));
    lBuilder.append('\n');
    return lBuilder;
  }
