...
/**
 * This class implements the test suite for service TxRequiredService.
 */
public class TxRequiredServiceTest extends TxRequiredServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxRequiredServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxRequiredServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxRequiredServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxRequiredServiceTest( String pName, String pUserId, String pPassword ) {
