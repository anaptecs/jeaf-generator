...
/**
 * This class implements the test suite for service JEAFAuthorizationTestService.
 */
public class JEAFAuthorizationTestServiceTest extends JEAFAuthorizationTestServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("JEAFAuthorizationTestServiceTest");
    // Add all test of this class.
    lSuite.addTest(new JEAFAuthorizationTestServiceTest("testDoAnotherthing1"));
    lSuite.addTest(new JEAFAuthorizationTestServiceTest("testDoSomething"));
   ...
   */
  public JEAFAuthorizationTestServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public JEAFAuthorizationTestServiceTest( String pName, String pUserId, String pPassword ) {
  ...
  /**
   * Method test the implementation of service method doAnotherthing1
   *
   * @throws Exception if a test fails.
   */
  @Override
  public void testDoAnotherthing1( ) throws Exception {
    // TODO Implement test for service method doAnotherthing1(...)
  }
