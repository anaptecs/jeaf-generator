...
/**
 * This class implements the test suite for service TxRequiresNewService.
 */
public class TxRequiresNewServiceTest extends TxRequiresNewServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxRequiresNewServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxRequiresNewServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxRequiresNewServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxRequiresNewServiceTest( String pName, String pUserId, String pPassword ) {
