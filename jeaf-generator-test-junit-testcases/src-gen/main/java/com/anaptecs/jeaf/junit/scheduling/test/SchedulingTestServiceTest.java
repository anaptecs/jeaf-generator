...
/**
 * This class implements the test suite for service SchedulingTestService.
 */
public class SchedulingTestServiceTest extends SchedulingTestServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("SchedulingTestServiceTest");
   ...
   */
  public SchedulingTestServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public SchedulingTestServiceTest( String pName, String pUserId, String pPassword ) {
