...
/**
 * This class implements the test suite for service ParentService.
 */
public class ParentServiceTest extends ParentServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("ParentServiceTest");
    // Add all test of this class.
    lSuite.addTest(new ParentServiceTest("testParentServiceMethod"));
   ...
   */
  public ParentServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public ParentServiceTest( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testParentServiceMethod( ) throws Exception {
    // TODO Implement test for service method parentServiceMethod(...)
  }
}