...
/**
 * This class implements the test suite for service DeprecatedRESTService.
 */
public class DeprecatedRESTServiceTest extends DeprecatedRESTServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("DeprecatedRESTServiceTest");
    // Add all test of this class.
    lSuite.addTest(new DeprecatedRESTServiceTest("testDoSomething"));
   ...
   */
  public DeprecatedRESTServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public DeprecatedRESTServiceTest( String pName, String pUserId, String pPassword ) {
