...
/**
 * This class implements the test suite for service JEAFSecurityTestService.
 */
public class JEAFSecurityTestServiceTest extends JEAFSecurityTestServiceTestBase {
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("JEAFSecurityTestServiceTest");
    // Add all test of this class.
    lSuite.addTest(new JEAFSecurityTestServiceTest("testCheckCurrentUser"));
    lSuite.addTest(new JEAFSecurityTestServiceTest("testCheckCurrentAnonymousUser"));
    lSuite.addTest(new JEAFSecurityTestServiceTest("testCheckInvalidServiceAccess"));
   ...
   */
  public JEAFSecurityTestServiceTest( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testCheckCurrentUser( ) throws Exception {
    // TODO Implement test for service method checkCurrentUser(...)
  }
   ...
   */
  @Override
  public void testCheckCurrentAnonymousUser( ) throws Exception {
    // TODO Implement test for service method checkCurrentAnonymousUser(...)
  }
   ...
   */
  @Override
  public void testCheckInvalidServiceAccess( ) throws Exception {
    // TODO Implement test for service method checkInvalidServiceAccess(...)
  }
}