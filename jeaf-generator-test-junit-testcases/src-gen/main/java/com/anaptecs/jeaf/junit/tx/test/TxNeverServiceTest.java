...
/**
 * This class implements the test suite for service TxNeverService.
 */
public class TxNeverServiceTest extends TxNeverServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxNeverServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxNeverServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxNeverServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxNeverServiceTest( String pName, String pUserId, String pPassword ) {
