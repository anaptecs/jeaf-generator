...
/**
 * This class implements the test suite for service MyCustomDefaultService.
 */
public class MyCustomDefaultServiceTest extends MyCustomDefaultServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("MyCustomDefaultServiceTest");
    // Add all test of this class.
    lSuite.addTest(new MyCustomDefaultServiceTest("testDoSomeMore"));
    lSuite.addTest(new MyCustomDefaultServiceTest("testDoSomething"));
   ...
   */
  public MyCustomDefaultServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public MyCustomDefaultServiceTest( String pName, String pUserId, String pPassword ) {
  ...
  /**
   * Method test the implementation of service method doSomeMore
   *
   * @throws Exception if a test fails.
   */
  @Override
  public void testDoSomeMore( ) throws Exception {
    // TODO Implement test for service method doSomeMore(...)
  }
