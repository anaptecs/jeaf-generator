...
/**
 * This class implements the test suite for service InternalStuffService.
 */
public class InternalStuffServiceTest extends InternalStuffServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("InternalStuffServiceTest");
    // Add all test of this class.
    lSuite.addTest(new InternalStuffServiceTest("testTestFlush"));
   ...
   */
  public InternalStuffServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public InternalStuffServiceTest( String pName, String pUserId, String pPassword ) {
