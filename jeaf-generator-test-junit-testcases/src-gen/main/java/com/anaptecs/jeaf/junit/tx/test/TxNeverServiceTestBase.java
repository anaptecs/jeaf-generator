...
/**
 * This is the base class of the test suite of service TxNeverService.
 *
 * @version $LastChangedRevision: 931 $
 */
public abstract class TxNeverServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected TxNeverService txNeverService;
   ...
   */
  public TxNeverServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public TxNeverServiceTestBase( String pName, String pUserId, String pPassword ) {
