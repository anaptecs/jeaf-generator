...
/**
 * This is the base class of the test suite of service InternalStuffService.
 * 
 * @version $LastChangedRevision: 931 $
 */
public abstract class InternalStuffServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected InternalStuffService internalStuffService;
   ...
   */
  public InternalStuffServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public InternalStuffServiceTestBase( String pName, String pUserId, String pPassword ) {
