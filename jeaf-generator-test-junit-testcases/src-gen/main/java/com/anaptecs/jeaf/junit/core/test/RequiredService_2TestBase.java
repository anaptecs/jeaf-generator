...
/**
 * This is the base class of the test suite of service RequiredService_2.
 * 
 * @version $LastChangedRevision: 931 $
 */
public abstract class RequiredService_2TestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected RequiredService_2 requiredService_2;
   ...
   */
  public RequiredService_2TestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public RequiredService_2TestBase( String pName, String pUserId, String pPassword ) {
   ...
   */
  public abstract void testTestContextHandling_2( ) throws Exception;
}