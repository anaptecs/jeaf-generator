...
/**
 * This is the base class of the test suite of service JEAFAuthorizationTestService.
 *
 * @version $LastChangedRevision: 931 $
 */
public abstract class JEAFAuthorizationTestServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected JEAFAuthorizationTestService jEAFAuthorizationTestService;
   ...
   */
  public JEAFAuthorizationTestServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public JEAFAuthorizationTestServiceTestBase( String pName, String pUserId, String pPassword ) {
   ...
   */
  public abstract void testDoAnotherthing1( ) throws Exception;
