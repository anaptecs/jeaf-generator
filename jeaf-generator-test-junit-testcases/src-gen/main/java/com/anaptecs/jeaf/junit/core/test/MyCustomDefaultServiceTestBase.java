...
import com.anaptecs.jeaf.junit.core.MyCustomDefaultService;

/**
 * This is the base class of the test suite of service MyCustomDefaultService.
 *
 * @version $LastChangedRevision: 931 $
 */
public abstract class MyCustomDefaultServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected MyCustomDefaultService myCustomDefaultService;
   ...
   */
  public MyCustomDefaultServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public MyCustomDefaultServiceTestBase( String pName, String pUserId, String pPassword ) {
   ...
   */
  public abstract void testDoSomeMore( ) throws Exception;
