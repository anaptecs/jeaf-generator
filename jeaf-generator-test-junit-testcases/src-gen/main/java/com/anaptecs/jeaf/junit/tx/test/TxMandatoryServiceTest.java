...
/**
 * This class implements the test suite for service TxMandatoryService.
 */
public class TxMandatoryServiceTest extends TxMandatoryServiceTestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("TxMandatoryServiceTest");
    // Add all test of this class.
    lSuite.addTest(new TxMandatoryServiceTest("testTestTransactionBehavior"));
   ...
   */
  public TxMandatoryServiceTest( String pName ) {
    super(pName);
  }
   ...
   */
  public TxMandatoryServiceTest( String pName, String pUserId, String pPassword ) {
