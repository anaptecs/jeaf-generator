...
/**
 * This is the base class of the test suite of service TxMandatoryService.
 *
 * @version $LastChangedRevision: 931 $
 */
public abstract class TxMandatoryServiceTestBase extends JEAFTestCase {
  /**
   * Service that should be tested by this test case.
   */
  @JEAFService
  protected TxMandatoryService txMandatoryService;
   ...
   */
  public TxMandatoryServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public TxMandatoryServiceTestBase( String pName, String pUserId, String pPassword ) {
