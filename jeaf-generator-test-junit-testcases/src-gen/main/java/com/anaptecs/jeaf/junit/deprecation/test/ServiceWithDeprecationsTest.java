...
/**
 * This class implements the test suite for service ServiceWithDeprecations.
 */
public class ServiceWithDeprecationsTest extends ServiceWithDeprecationsTestBase {
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("ServiceWithDeprecationsTest");
    // Add all test of this class.
    lSuite.addTest(new ServiceWithDeprecationsTest("testCreateSomething"));
   ...
   */
  public ServiceWithDeprecationsTest( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testCreateSomething( ) throws Exception {
    // TODO Implement test for service method createSomething(...)
  }
}