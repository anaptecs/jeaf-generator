...
/**
 * This class implements the test suite for service RequiredService_1.
 */
public class RequiredService_1Test extends RequiredService_1TestBase {
  /**
  ...
  public static TestSuite suite( ) {
    ...
    TestSuite lSuite = new TestSuite("RequiredService_1Test");
    // Add all test of this class.
    lSuite.addTest(new RequiredService_1Test("testTestContextHandling_1"));
   ...
   */
  public RequiredService_1Test( String pName ) {
    super(pName);
  }
   ...
   */
  public RequiredService_1Test( String pName, String pUserId, String pPassword ) {
   ...
   */
  @Override
  public void testTestContextHandling_1( ) throws Exception {
    // TODO Implement test for service method testContextHandling_1(...)
  }
}