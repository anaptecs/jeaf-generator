...
import com.anaptecs.jeaf.junit.core.DefaultService;

/**
 * This is the base class of the test suite of service DefaultService.
 *
 * @version $LastChangedRevision: 931 $
 */
public abstract class DefaultServiceTestBase extends JEAFTestCase {
  /**
   ...
   */
  public DefaultServiceTestBase( String pName ) {
    super(pName);
  }
   ...
   */
  public DefaultServiceTestBase( String pName, String pUserId, String pPassword ) {
   ...
   */
  public abstract void testGetFloatWithDefault( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testDoNothing( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testCustomImplNoDefault( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testThrowNYI( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testCustomImpl( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testGetColor( ) throws Exception;
   ...
   * @throws Exception if the test fails.
   */
  public abstract void testCustomTemplate( ) throws Exception;
}