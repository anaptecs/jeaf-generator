...
public class ProductServiceResource {
        ...
        lWorkloadManager.execute(lRequestInfo, new RESTWorkloadErrorHandler(pAsyncResponse), new Runnable() {
            ...
            public void run( ) {
                try {
                    ...
                    javax.ws.rs.core.Response lResponseObject = javax.ws.rs.core.Response
                                    .status(javax.ws.rs.core.Response.Status.OK).entity(lResult).build();
    ...
    public javax.ws.rs.core.Response testDateQueryParams( @PathParam("path") String pPath,
                    ...
                    @QueryParam("startTime") OffsetTime pStartTime,
                    @QueryParam("localStartTimestamp") LocalDateTime pLocalStartTimestamp,
                    @QueryParam("localStartTime") LocalTime pLocalStartTime,
                    @QueryParam("localStartDate") LocalDate pLocalStartDate, @QueryParam("calendar") Calendar pCalendar,
                    @QueryParam("utilDate") java.util.Date pUtilDate,
    ...
    public javax.ws.rs.core.Response testOptionalQueryParams(
                    @QueryParam("query1") @DefaultValue("Just a default value") String query1,
    ...
    public javax.ws.rs.core.Response testDataTypeWithRestrition(
                    @PathParam("string-code") String pStringCodeAsBasicType,
                    @QueryParam("short-codes") short[] pShortCodesAsBasicType,
                    @QueryParam("byte-code") Byte pJustAByte ) {
        // Convert basic type parameters into "real" objects.
