 ...
 */
     ...
     * @return {@link Builder} New builder that can be used to create new SoftLink objects. The method never
     * returns null.
     */
	...
	/**
	 * Class implements builder to create a new instance of class SoftLink. As the class has readonly attributes
	...
	public static class Builder extends SoftLink.BuilderBase {
	  ...
	  protected Builder( SoftLink pObject ) {
	    super(pObject);
				   ...
				   * @return {@link SoftLink} Instance of this class as it was deserialized from the passed string. The method must not return null.
				   */
