...
*/
	...
	/**
	 * Class implements builder to create a new instance of class AbtractWithDerivedPropertyAndCustomImpl. As the class has readonly attributes
	 * or associations instances can not be created directly. Instead this builder class has to be used.
	 */
	public static  abstract class Builder extends AbtractWithDerivedPropertyAndCustomImpl.BuilderBase {
	  /**
	   * Use {@link AbtractWithDerivedPropertyAndCustomImpl#builder()} instead of protected constructor to create new builder.
	   */
	  protected Builder( ) {
	  }
	
	  /**
	   * Use {@link AbtractWithDerivedPropertyAndCustomImpl#builder(AbtractWithDerivedPropertyAndCustomImpl)} instead of protected constructor to create new builder.
	   */
