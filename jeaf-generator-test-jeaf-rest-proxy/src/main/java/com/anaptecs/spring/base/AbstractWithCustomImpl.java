...
*/
	...
	/**
	 * Class implements builder to create a new instance of class AbstractWithCustomImpl. As the class has readonly attributes
	...
	public static  abstract class Builder extends AbstractWithCustomImpl.BuilderBase {
	  ...
	  /**
	   * Use {@link AbstractWithCustomImpl#builder(AbstractWithCustomImpl)} instead of protected constructor to create new builder.
	   */
