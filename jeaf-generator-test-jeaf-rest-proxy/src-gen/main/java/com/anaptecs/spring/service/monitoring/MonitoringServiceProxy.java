...
/**
 * ServiceProxy class for JEAF service MonitoringService.
 */
public final class MonitoringServiceProxy extends ServiceProxy implements MonitoringService {
  /**
   ...
   */
  public MonitoringServiceProxy( TransactionBehavior pTransactionBehavior ) {
    super(MonitoringService.class, pTransactionBehavior);
  }
...
final class GetVersionInfo_MonitoringService_Command extends Command {
  ...
  static {
    try {
      SERVICE_METHOD = MonitoringService.class.getMethod("getVersionInfo");
    }
    catch (NoSuchMethodException e) {
      throw new JEAFSystemException(MessageConstants.SERVICE_METHOD_DOES_NOT_EXIST, e,
          MonitoringService.class.getName(), "getVersionInfo(null)");
    }
  }
  ...
  public Serializable execute( Service pTargetService ) {
    ...
    MonitoringService lService = (MonitoringService) pTargetService;
    // Trace service call.
