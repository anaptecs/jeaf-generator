...
/**
 * Class is factory class to create new instances of the component ProductManagementComponent.
 */
@com.anaptecs.jeaf.core.annotations.ComponentFactory
public final class ProductManagementComponentFactory implements ComponentFactory {
  /**
   ...
   * public constructor.
   */
  public ProductManagementComponentFactory( ) {
    // Create new component.
    component = new ProductManagementComponent();
    // Create new collection for all service factories.
    Collection<ServiceFactory> lServiceFactories = new ArrayList<ServiceFactory>();
    lServiceFactories.add(new RESTProductServiceFactory(component));
  ...
  /**
   * Method creates a new instance of component ProductManagementComponent.
   *
   * @return Component Created ProductManagementComponent. The method never returns null.
   *
