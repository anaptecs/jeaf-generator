...
public class SimpleBackwardCompatibility implements Serializable {
   ...
   */
  public static Builder builder( String pDeprecatedProperty, String pSuccessorProperty ) {
  ...
  public static class Builder {
    ...
    /**
     * Method creates a new validated instance of class SimpleBackwardCompatibility. The object will be initialized with
     * the values of the builder and validated afterwards.
     *
     * @return SimpleBackwardCompatibility Created and validated object. The method never returns null.
     * @throws ConstraintViolationException in case that one or more validations for the created object failed.
     */
    public SimpleBackwardCompatibility buildValidated( ) throws ConstraintViolationException {
      SimpleBackwardCompatibility lObject = this.build();
