...
public abstract class SoftLinkBase implements Serializable {
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(XFunMessages.OBJECT_ATTRIBUTE, "objectID", "" + objectID));
    lBuilder.append('\n');
    lBuilder
        .append(XFun.getMessageRepository().getMessage(XFunMessages.OBJECT_ATTRIBUTE, "refrenceID", "" + refrenceID));
    lBuilder.append('\n');
    return lBuilder;
  }
