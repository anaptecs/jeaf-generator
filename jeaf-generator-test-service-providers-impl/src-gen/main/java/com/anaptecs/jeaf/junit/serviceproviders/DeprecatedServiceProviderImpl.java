...
/**
 * This class is the base class of the service provider implementation DeprecatedServiceProviderImpl.
 *
 * 
 */
final class DeprecatedServiceProviderImpl extends DeprecatedServiceProviderImplBase {
  /**
   * Constructor has reduced visibility in order to ensure that all service provider implementations are created through
   * the factory.
   */
  DeprecatedServiceProviderImpl( ) {
    // Nothing to do.
  }
