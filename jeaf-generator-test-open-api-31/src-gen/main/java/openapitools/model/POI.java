...
public class POI extends Stop {
  ...
  private Set<String> evenMoreLinkIDs = new LinkedHashSet<>();
  ...
  public POI addEvenMoreLinkIDsItem(String evenMoreLinkIDsItem) {
    if (this.evenMoreLinkIDs == null) {
      this.evenMoreLinkIDs = new LinkedHashSet<>();
    }
  ...
  /**
   *  &lt;br&gt;&lt;br&gt; **Breaking Change Notice (active with 2024-12-24, go live date: , end of compatibility period: ):**&lt;br&gt;&lt;br&gt; New mandatory association is required to support upcoming features. 
   * @return stops
   */
  @javax.annotation.Nonnull
