...
public class ParentClass {
  ...
  private Set<String> ibans = new LinkedHashSet<>();
  ...
  public ParentClass objectType(@javax.annotation.Nonnull String objectType) {
  ...
  public ParentClass parentAttribute(@javax.annotation.Nonnull String parentAttribute) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PARENT_ATTRIBUTE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PARENT_ATTRIBUTE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParentAttribute(@javax.annotation.Nonnull String parentAttribute) {
    this.parentAttribute = parentAttribute;
  }
  ...
  @Deprecated
  public ParentClass theBankAccount(@javax.annotation.Nullable BankAccount theBankAccount) {
  ...
  @Deprecated
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_THE_BANK_ACCOUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_THE_BANK_ACCOUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTheBankAccount(@javax.annotation.Nullable BankAccount theBankAccount) {
    this.theBankAccount = theBankAccount;
  }


  @Deprecated
  public ParentClass legacyBankAccounts(@javax.annotation.Nullable List<BankAccount> legacyBankAccounts) {
  ...
  @Deprecated
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LEGACY_BANK_ACCOUNTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_LEGACY_BANK_ACCOUNTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLegacyBankAccounts(@javax.annotation.Nullable List<BankAccount> legacyBankAccounts) {
    this.legacyBankAccounts = legacyBankAccounts;
  }
