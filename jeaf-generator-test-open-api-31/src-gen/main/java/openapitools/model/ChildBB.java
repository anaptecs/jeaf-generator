...
public class ChildBB extends ChildB {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_CHILD_B_B_ATTRIBUTE, required = true)
  ...
  /**
   *  &lt;br&gt;&lt;br&gt; **Deprecation Notice (since: , removed with: , go live date: , end of compatibility period: ):**&lt;br&gt;&lt;br&gt; Please  keep &#x60;hands off&#x60;. 
   * @return deprecatedAttribute
   * @deprecated
   */
  @Deprecated
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_DEPRECATED_ATTRIBUTE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @Deprecated
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DEPRECATED_PARENT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DEPRECATED_ARRAY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
