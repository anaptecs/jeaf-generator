...
public class FareConnectionPointRef extends PlaceRef {
   ...
   * @return {@link Builder} New builder that can be used to create new FareConnectionPointRef objects. The method never
   * returns null.
   */
  public static Builder builder( FareConnectionPointRef pObject ) {
