...
/**
 * Reference to situation message. Message details might be found in response context or through other communication
 * channels. Provided by OJP.
 * 
...
public class SituationFullRef {
   ...
   */
  protected SituationFullRef( Builder pBuilder ) {
  ...
  public static class Builder {
    ...
    /**
     * Method creates a new instance of class SituationFullRef. The object will be initialized with the values of the
     * builder.
     * 
     * @return SituationFullRef Created object. The method never returns null.
     */
    public SituationFullRef build( ) {
      return new SituationFullRef(this);
    }

    /**
     * Method creates a new validated instance of class SituationFullRef. The object will be initialized with the values
     * of the builder and validated afterwards.
     * 
     * @return SituationFullRef Created and validated object. The method never returns null.
     * @throws ConstraintViolationException in case that one or more validations for the created object failed.
     */
    public SituationFullRef buildValidated( ) throws ConstraintViolationException {
      SituationFullRef lPOJO = this.build();
