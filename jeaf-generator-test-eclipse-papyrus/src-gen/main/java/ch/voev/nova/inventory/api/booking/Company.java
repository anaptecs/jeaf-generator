...
public class Company {
  ...
  public static class Builder {
    ...
    /**
     * Method sets the attribute "value". RICS company code or compatible ERA company code for rail.
     * 
  ...
  /**
   * Method returns the attribute "value". RICS company code or compatible ERA company code for rail.
   * 
