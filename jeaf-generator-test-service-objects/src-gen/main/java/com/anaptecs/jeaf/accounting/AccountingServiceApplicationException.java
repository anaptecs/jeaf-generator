...
public final class AccountingServiceApplicationException extends ApplicationException {
   ...
   */
  public AccountingServiceApplicationException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public AccountingServiceApplicationException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public AccountingServiceApplicationException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * null.
   */
  public AccountingServiceApplicationException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
