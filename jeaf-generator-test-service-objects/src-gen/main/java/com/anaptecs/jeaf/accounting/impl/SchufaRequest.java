...
public class SchufaRequest implements ServiceObject {
  ...
  /**
   * Class implements builder to create a new instance of class SchufaRequest. As the class has readonly attributes or
  ...
  public static class Builder {
     ...
     * @return SchufaRequest Created object. The method never returns null.
     */
    public SchufaRequest build( boolean pValidate ) {
