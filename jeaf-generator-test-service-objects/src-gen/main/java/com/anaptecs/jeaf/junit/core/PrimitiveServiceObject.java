...
public class PrimitiveServiceObject implements ServiceObject {
  ...
  /**
   * Class implements builder to create a new instance of class PrimitiveServiceObject. As the class has readonly
  ...
  public static class Builder {
     ...
     * @return PrimitiveServiceObject Created object. The method never returns null.
     */
    public PrimitiveServiceObject build( boolean pValidate ) {
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "aInt", "" + aInt));
    lBuilder.append('\n');
    ...
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "aChar", "" + aChar));
    lBuilder.append('\n');
    return lBuilder;
  }
