...
public class SimpleDatatypeServiceObject implements ServiceObject, Identifiable<ServiceObjectID> {
  ...
  /**
   * Class implements builder to create a new instance of class SimpleDatatypeServiceObject. As the class has readonly
  ...
  public static class Builder {
     ...
     * @return SimpleDatatypeServiceObject Created object. The method never returns null.
     */
    public SimpleDatatypeServiceObject build( boolean pValidate ) {
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "myChar", "" + myChar));
    lBuilder.append('\n');
    lBuilder
