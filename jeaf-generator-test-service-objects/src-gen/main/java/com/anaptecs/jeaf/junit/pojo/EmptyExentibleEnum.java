...
public final class EmptyExentibleEnum {
  public static enum EmptyExentibleEnumType {
    /**
   ...
   */
  private EmptyExentibleEnumType literal;
   ...
   * @return
   */
  public static EmptyExentibleEnum valueOf( String pLiteralName ) {
    EmptyExentibleEnum lEnum;
    try {
      EmptyExentibleEnumType lEnumValue = Enum.valueOf(EmptyExentibleEnumType.class, pLiteralName);
      switch (lEnumValue) {
        default:
          lEnum = new EmptyExentibleEnum(lEnumValue);
      }
    }
    catch (IllegalArgumentException e) {
      lEnum = new EmptyExentibleEnum(pLiteralName);
    }
    return lEnum;
  }
   ...
   * object creation available constructors {@link #EmptyExentibleEnum(EmptyExentibleEnumType)} and
   * {@link #EmptyExentibleEnum(String)} should be used.
   */
  EmptyExentibleEnum( ) {
  }
   ...
   * must not be null.
   */
  public EmptyExentibleEnum( EmptyExentibleEnumType pLiteral ) {
   ...
   *
   * @see EmptyExentibleEnum#isUnknownLiteral()
   */
  public EmptyExentibleEnum( String pLiteralName ) {
    try {
      literal = Enum.valueOf(EmptyExentibleEnumType.class, pLiteralName);
      unknownLiteralName = null;
    }
    // Literal is unknown
    catch (IllegalArgumentException e) {
      literal = EmptyExentibleEnumType.UNKNOWN;
   ...
   *
   * @return {@link EmptyExentibleEnum} Literal that is represented by this object. The method never returns null.
   */
  public EmptyExentibleEnumType getLiteral( ) {
    return literal;
  }
  ...
  public boolean isUnknownLiteral( ) {
    return literal == EmptyExentibleEnumType.UNKNOWN;
  }
  ...
  public boolean equals( Object pObject ) {
    ...
    if (pObject != null) {
      ...
      // Passed object is of same type
        ...
        EmptyExentibleEnum lEnum = (EmptyExentibleEnum) pObject;
