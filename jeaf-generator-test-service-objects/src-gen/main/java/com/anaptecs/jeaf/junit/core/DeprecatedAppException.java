 ...
 */
@Deprecated
public final class DeprecatedAppException extends ApplicationException {
  /**
   ...
   */
  public DeprecatedAppException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public DeprecatedAppException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public DeprecatedAppException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * null.
   */
  public DeprecatedAppException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public DeprecatedAppException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
