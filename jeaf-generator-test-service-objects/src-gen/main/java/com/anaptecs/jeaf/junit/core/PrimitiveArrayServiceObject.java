...
public class PrimitiveArrayServiceObject implements ServiceObject {
  ...
  /**
   * Class implements builder to create a new instance of class PrimitiveArrayServiceObject. As the class has readonly
  ...
  public static class Builder {
     ...
     * @return PrimitiveArrayServiceObject Created object. The method never returns null.
     */
    public PrimitiveArrayServiceObject build( boolean pValidate ) {
