 ...
 */
public class TestServiceObject implements ServiceObject {
  /**
   ...
   */
  protected TestServiceObject( Builder pBuilder ) {
  ...
  public static class Builder {
    ...
    /**
     * Use {@link #newBuilder(TestServiceObject)} instead of private constructor to create new builder.
     */
     ...
     * returns null.
     */
    public static Builder newBuilder( TestServiceObject pObject ) {
     ...
     */
    public Builder setInfo( String pInfo ) {
      // Assign value to attribute
      info = pInfo;
      return this;
    }
     ...
     */
    public Builder setSomeTest( int pSomeTest ) {
      // Assign value to attribute
      someTest = pSomeTest;
      return this;
    }
     ...
     */
    public Builder setDummy1( Double pDummy1 ) {
      // Assign value to attribute
      dummy1 = pDummy1;
      return this;
    }
     ...
     */
    public Builder setDummy2( String[] pDummy2 ) {
      // Assign value to attribute
      if (pDummy2 != null) {
     ...
     */
    public Builder setDummy3( Integer[] pDummy3 ) {
      // Assign value to attribute
      if (pDummy3 != null) {
     ...
     * @return TestServiceObject Created object. The method never returns null.
     */
    public TestServiceObject build( boolean pValidate ) {
  ...
  protected StringBuilder toStringBuilder( ) {
    ...
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "info", "" + info));
    lBuilder.append('\n');
    lBuilder
        .append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "someTest", "" + someTest));
    lBuilder.append('\n');
    lBuilder.append(XFun.getMessageRepository().getMessage(MessageConstants.OBJECT_ATTRIBUTE, "dummy1", "" + dummy1));
    lBuilder.append('\n');
    return lBuilder;
  }
