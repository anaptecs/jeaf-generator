...
public class ModelWrapperArrayServiceObject implements ServiceObject {
   ...
   */
  public static Builder builder( ModelWrapperArrayServiceObject pObject ) {
    return new Builder(pObject);
  }

  /**
   * Class implements builder to create a new instance of class ModelWrapperArrayServiceObject. As the class has read
  ...
  public static class Builder {
    ...
    public ModelWrapperArrayServiceObject buildValidated( ) throws ConstraintViolationException {
      ModelWrapperArrayServiceObject lPOJO = this.build();
