...
public class InputSubclass extends Input {
  ...
  /**
   * Class implements builder to create a new instance of class InputSubclass. As the class has readonly attributes or
  ...
  public static class Builder extends Input.Builder {
     ...
     * @return InputSubclass Created object. The method never returns null.
     */
    public InputSubclass build( boolean pValidate ) {
