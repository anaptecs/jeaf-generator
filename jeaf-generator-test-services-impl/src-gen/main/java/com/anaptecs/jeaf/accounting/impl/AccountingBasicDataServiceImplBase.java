 ...
 */
abstract class AccountingBasicDataServiceImplBase implements AccountingBasicDataService, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String CREATEBANK_AUTH_TYPE =
      "createBank.com.anaptecs.jeaf.accounting.AccountingBasicDataService";

  public static final String CREATEEMPLOYEE_AUTH_TYPE =
      "createEmployee.com.anaptecs.jeaf.accounting.AccountingBasicDataService";

  public static final String CREATERESPONSIBILITYTYPE_AUTH_TYPE =
      "createResponsibilityType.com.anaptecs.jeaf.accounting.AccountingBasicDataService";
   ...
   * Initialize object.
   */
  AccountingBasicDataServiceImplBase( Component pComponent ) {
    // Check parameter
