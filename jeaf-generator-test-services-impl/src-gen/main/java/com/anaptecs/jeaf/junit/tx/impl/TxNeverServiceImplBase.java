...
/**
 * Implementation of TxNeverService.
 */
abstract class TxNeverServiceImplBase implements TxNeverService, ServiceImplementation {
  /*
  ...
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxNeverService";
   ...
   * Initialize object.
   */
  TxNeverServiceImplBase( Component pComponent ) {
    // Check parameter
