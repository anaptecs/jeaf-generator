 ...
 */
abstract class JEAFSecurityTestServiceImplBase implements JEAFSecurityTestService, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String CHECKCURRENTANONYMOUSUSER_AUTH_TYPE =
      "checkCurrentAnonymousUser.com.anaptecs.jeaf.junit.core.JEAFSecurityTestService";

  public static final String CHECKCURRENTUSER_AUTH_TYPE =
      "checkCurrentUser.com.anaptecs.jeaf.junit.core.JEAFSecurityTestService";

  public static final String CHECKINVALIDSERVICEACCESS_AUTH_TYPE =
      "checkInvalidServiceAccess.com.anaptecs.jeaf.junit.core.JEAFSecurityTestService";
   ...
   * Initialize object.
   */
  JEAFSecurityTestServiceImplBase( Component pComponent ) {
    // Check parameter
  ...
  public final Class<? extends Service> getServiceType( ) {
    return JEAFSecurityTestService.class;
  }
