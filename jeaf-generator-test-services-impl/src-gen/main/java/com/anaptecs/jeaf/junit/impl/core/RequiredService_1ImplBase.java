...
/**
 * Implementation of RequiredService_1.
 */
abstract class RequiredService_1ImplBase implements RequiredService_1, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String TESTCONTEXTHANDLING_1_AUTH_TYPE =
      "testContextHandling_1.com.anaptecs.jeaf.junit.core.RequiredService_1";
   ...
   * Initialize object.
   */
  RequiredService_1ImplBase( Component pComponent ) {
    // Check parameter
