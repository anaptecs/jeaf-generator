 ...
 */
abstract class TxRequiredServiceImplBase implements TxRequiredService, ServiceImplementation {
  /*
  ...
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxRequiredService";
   ...
   * Initialize object.
   */
  TxRequiredServiceImplBase( Component pComponent ) {
    // Check parameter
