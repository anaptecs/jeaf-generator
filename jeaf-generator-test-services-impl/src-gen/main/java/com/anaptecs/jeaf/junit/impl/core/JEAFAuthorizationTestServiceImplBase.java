...
/**
 * Implementation of JEAFAuthorizationTestService.
 */
abstract class JEAFAuthorizationTestServiceImplBase implements JEAFAuthorizationTestService, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String DOANOTHERTHING1_AUTH_TYPE =
      "doAnotherthing1.com.anaptecs.jeaf.junit.core.JEAFAuthorizationTestService";

  public static final String DOSOMETHING_AUTH_TYPE =
      "doSomething.com.anaptecs.jeaf.junit.core.JEAFAuthorizationTestService";
   ...
   * Initialize object.
   */
  JEAFAuthorizationTestServiceImplBase( Component pComponent ) {
    // Check parameter
  ...
  public final Class<? extends Service> getServiceType( ) {
    return JEAFAuthorizationTestService.class;
  }
