...
/**
 * Implementation of InterceptorTestService.
 */
abstract class InterceptorTestServiceImplBase implements InterceptorTestService, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String CALLSERVICEAPE_AUTH_TYPE =
      "callServiceAPE.com.anaptecs.jeaf.junit.core.InterceptorTestService";

  public static final String CALLSERVICEERR_AUTH_TYPE =
      "callServiceERR.com.anaptecs.jeaf.junit.core.InterceptorTestService";

  public static final String CALLSERVICERTE_AUTH_TYPE =
      "callServiceRTE.com.anaptecs.jeaf.junit.core.InterceptorTestService";

  public static final String CALLSERVICESYE_AUTH_TYPE =
      "callServiceSYE.com.anaptecs.jeaf.junit.core.InterceptorTestService";

  public static final String CALLSERVICE_AUTH_TYPE = "callService.com.anaptecs.jeaf.junit.core.InterceptorTestService";
   ...
   * Initialize object.
   */
  InterceptorTestServiceImplBase( Component pComponent ) {
    // Check parameter
  ...
  public final Class<? extends Service> getServiceType( ) {
    return InterceptorTestService.class;
  }
