...
/**
 * Implementation of TxSupportedService.
 */
abstract class TxSupportedServiceImplBase implements TxSupportedService, ServiceImplementation {
  /*
  ...
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxSupportedService";
   ...
   * Initialize object.
   */
  TxSupportedServiceImplBase( Component pComponent ) {
    // Check parameter
