...
/**
 * Implementation of TxRequiresNewService.
 */
abstract class TxRequiresNewServiceImplBase implements TxRequiresNewService, ServiceImplementation {
  /*
  ...
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxRequiresNewService";
   ...
   * Initialize object.
   */
  TxRequiresNewServiceImplBase( Component pComponent ) {
    // Check parameter
