...
/**
 * Implementation of TxMandatoryService.
 */
abstract class TxMandatoryServiceImplBase implements TxMandatoryService, ServiceImplementation {
  /*
  ...
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxMandatoryService";
   ...
   * Initialize object.
   */
  TxMandatoryServiceImplBase( Component pComponent ) {
    // Check parameter
