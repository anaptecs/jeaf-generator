...
import com.anaptecs.jeaf.junit.core.InterceptorTestApplicationException;
 ...
 */
final class InterceptorTestServiceImpl extends InterceptorTestServiceImplBase {
  /**
   * Initialize object.
   */
  InterceptorTestServiceImpl( Component pComponent ) {
    super(pComponent);
  }
