...
/**
 * Implementation of RequiredService_2.
 */
abstract class RequiredService_2ImplBase implements RequiredService_2, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String TESTCONTEXTHANDLING_2_AUTH_TYPE =
      "testContextHandling_2.com.anaptecs.jeaf.junit.core.RequiredService_2";
   ...
   * Initialize object.
   */
  RequiredService_2ImplBase( Component pComponent ) {
    // Check parameter
