...
/**
 * Implementation of TxNotSupportedService.
 */
abstract class TxNotSupportedServiceImplBase implements TxNotSupportedService, ServiceImplementation {
  /*
   * The following constants define the names of all authorization types of the service.
   */
  public static final String TESTTRANSACTIONBEHAVIOR_AUTH_TYPE =
      "testTransactionBehavior.com.anaptecs.jeaf.junit.tx.TxNotSupportedService";
   ...
   * Initialize object.
   */
  TxNotSupportedServiceImplBase( Component pComponent ) {
    // Check parameter
