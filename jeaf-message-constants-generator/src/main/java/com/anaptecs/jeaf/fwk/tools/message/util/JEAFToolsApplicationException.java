...
/**
 * Application exception that is used by all JEAF tools in order to indicate application specific problems.
 * 
 ...
 */
public class JEAFToolsApplicationException extends ApplicationException {
  /**
   ...
   */
  public JEAFToolsApplicationException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public JEAFToolsApplicationException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public JEAFToolsApplicationException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * @param pCause Throwable object that caused this exception. The parameter may be null.
   */
  public JEAFToolsApplicationException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
