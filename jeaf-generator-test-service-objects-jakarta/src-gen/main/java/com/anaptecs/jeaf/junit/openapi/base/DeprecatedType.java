...
@Deprecated
public class DeprecatedType implements ServiceObject {
  /**
   ...
   */
  @Deprecated
  public static Builder builder( DeprecatedType pObject ) {
  ...
  public static class Builder {
    ...
    public DeprecatedType build( ) {
      DeprecatedType lObject = new DeprecatedType(this);
  ...
  public boolean equals( Object pOtherObject ) {
    ...
    else if (pOtherObject instanceof DeprecatedType == false) {
      lEquals = false;
    }
    else {
      lEquals = Objects.equals(code, ((DeprecatedType) pOtherObject).getCode());
    }
    return lEquals;
  }
