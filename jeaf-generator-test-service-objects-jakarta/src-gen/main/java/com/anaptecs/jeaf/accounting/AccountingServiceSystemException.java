...
public final class AccountingServiceSystemException extends SystemException {
   ...
   */
  public AccountingServiceSystemException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public AccountingServiceSystemException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public AccountingServiceSystemException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * @param pCause Throwable object that caused this exception. The parameter may be null.
   */
  public AccountingServiceSystemException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public AccountingServiceSystemException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
